  ...
  strategies: {
    pullback: {
      ...
      scores: [
        ...
        { code: 'D4', condition: '대차잔고(공매도) 추이 — 최근 10거래일 잔고 감소율 ≥10% 만점·5~10% 부분 (숏커버링 징후, 시가총액 100위 이내 대형주만 수집)', source: 'pykrx · KRX 정보데이터시스템 · 공매도 종합포털' },
        { code: 'V1', condition: '시장·종목 혼합 변동성 기준으로 눌림목 적합도를 보조 가감점', source: '시장 레짐 + 최근 20일 일봉 변동성' }
      ],
      scoreNote: '2026-06 재채점: 등급은 D1·D2·D3·D4 + S2·P2·C1·C5만 반영. S1·S3·P1·P3·C2·C3·C4는 수익과 무/역상관이라 등급 제외(진단 표시만 유지). D4(대차잔고 추이)는 시가총액 100위 이내 대형주만 수집되며, 그 외 종목은 데이터 부족으로 등급에 영향 없이 진단으로만 표시됩니다.'
    },
    breakout: {
      gates: [
      ...
      scores: [
        ...
        { code: 'L1', condition: '대차잔고(공매도) 추이 — 최근 10거래일 잔고 증가율 ≥10% 만점·5~10% 부분 (숏스퀴즈 동력, 시가총액 100위 이내 대형주만 수집)', source: 'pykrx · KRX 정보데이터시스템 · 공매도 종합포털' },
        { code: 'V1', condition: '시장·종목 혼합 변동성 기준으로 저변동성 유리, 고변동성 불리 보조 가감점', source: '시장 레짐 + 최근 20일 일봉 변동성' }
      ],
      scoreNote: 'L1(대차잔고)은 시가총액 100위 이내 대형주만 수집되며, 그 외 종목은 데이터 부족으로 등급에 영향 없이 진단으로만 표시됩니다.'
    },
    accumulation: {
      gates: [
      ...
      scores: [
        ...
        { code: 'L1', condition: '대차잔고(공매도) 추이 — 최근 10거래일 잔고 감소율 ≥10% 만점·5~10% 부분 (클린 매집 징후, 시가총액 100위 이내 대형주만 수집)', source: 'pykrx · KRX 정보데이터시스템 · 공매도 종합포털' },
