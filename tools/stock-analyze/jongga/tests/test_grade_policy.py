...
class GradePolicyTest(unittest.TestCase):
    ...
    def test_reversal_grade_thresholds_relaxed(self):
        self.assertEqual(grade_from_score(8.0, "reversal"), "S")
        self.assertEqual(grade_from_score(7.9, "reversal"), "A")
        self.assertEqual(grade_from_score(6.5, "reversal"), "A")
        self.assertEqual(grade_from_score(5.0, "reversal"), "B")
