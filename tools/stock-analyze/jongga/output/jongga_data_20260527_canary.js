        ...
        "pullback": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G5",
                "status": "⛔",
                "note": "KOSPI>7833.95, VKOSPI 71.25 · VKOSPI 과열",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
            ...
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 -4.48% / KOSPI +2.52% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 27650,
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 1,984,400 > 20MA 1,727,300 > 60MA 1,239,650",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 2,244,000 / 60MA 1,239,650",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "주봉 RSI 84.6 (필요 ≥ 50)",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "종가 2,244,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 2,182,000 ≤ 종가 2,244,000)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "P1",
                "note": "20일 고점 대비 -4.8% (필요 -7%~-15%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 242% (필요 100~180%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 -4.02% / KOSPI +2.52% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 2244000,
            "previousClose": 2052000,
            "dailyChange": 192000,
            "dailyChangePct": 9.36,
            "dailyDirection": "up",
            "entryPriceText": "2,244,000원 (당일 종가 기준)",
            "entryPrice": 2244000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 225,600 > 20MA 183,740 > 60MA 139,540",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 235,500 / 60MA 139,540",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "주봉 RSI 83.6 (필요 ≥ 50)",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "20일 고점 대비 -11.6% (필요 -7%~-15%)",
                "evalStatus": "met"
              },
              {
                "code": "P2",
                "note": "종가 235,500 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C2",
            ...
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 -5.98% / KOSPI +2.52% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 235500,
            ...
            "dailyChangePct": -1.67,
            "dailyDirection": "down",
            "entryPriceText": "235,500원 (당일 종가 기준)",
            "entryPrice": 235500,
            "entryMeta": "당일 종가 기준",
        ...
        "momentum": [
          {
            ...
            "unmatchedRules": [
              {
                "code": "S1",
                "note": "외인 -265,265주 / 기관 106,220주 · 동시 순매수 아님",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "몸통 17% / 윗꼬리·몸통 1.91",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 691000,
            ...
            "dailyChangePct": 4.07,
            "dailyDirection": "up",
            "entryPriceText": "691,000원 (당일 종가 기준)",
            "entryPrice": 691000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "상대강도 상위 여부와 돌파 지속성을 공개 데이터로 계산했습니다. 외인 -265,265주 / 기관 106,220주.",
            "notes": [],
            "toss": {
              "avgStrength": 119.0,
              "note": "토스 공개 체결강도 119.0% / 최근 체결 2분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A012330/order",
              "asOf": "2026-05-27T06:08:08Z",
            ...
            "orderbook": {
              ...
              "bidTotal": 36249,
              "askTotal": 6036,
              "note": "토스 호가잔량합계 매수 36,249 / 매도 6,036",
          ...
          },
          {
            ...
            "unmatchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 94.0% / 100% 유지 100.0% (필요 ≥110%·≥70%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C1",
            ...
            "orderbook": {
              ...
              "bidTotal": 262176,
              "askTotal": 128006,
              "note": "토스 호가잔량합계 매수 262,176 / 매도 128,006",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "5일 초과 -0.7% / 20일 초과 +5.3%",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
                "status": "⛔",
                "note": "52주 고가 대비 87.9% (필요 ≥ 92%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G4",
            ...
            "unmatchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 81.0% / 100% 유지 50.0% (필요 ≥110%·≥70%)",
                "evalStatus": "not_met"
              },
              {
                "code": "P1",
                "note": "20일 고점 대비 87.9% (필요 ≥ 95%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "몸통 45% / 윗꼬리·몸통 0.45",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 681000,
            ...
            "toss": {
              ...
              "asOf": "2026-05-27T06:08:07Z",
              "intradayAbove100Ratio": 50.0,
              "observedMinutes": 2,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 2분 프록시",
              "lastHourAvgStrength": 186.1,
              "lastHourObservedMinutes": 2
            },
            "orderbook": {
              "bidAskRatio": 1.8161,
              "bidTotal": 28690,
              "askTotal": 15798,
              "note": "토스 호가잔량합계 매수 28,690 / 매도 15,798",
              "source": "toss_quotes_api",
        ...
        "reversal": [
          {
            ...
            "filters": [
              ...
              },
              {
                "code": "F2",
                "status": "✅",
                "note": "시총 62.7조 (필요 ≥ 30조)",
                "evalStatus": "met"
              },
              {
                "code": "F3",
                "status": "⛔",
                "note": "KIND 최근공시 2026-05-22 기업설명회(IR) 개최(안내공시)",
            ...
            "matchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 119.0% / 마지막 1시간 300.0% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 691,000 / 20MA 544,450",
                "evalStatus": "met"
              },
              {
                "code": "P2",
              ...
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 257% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C2",
                "note": "매수/매도 호가잔량 6.01 (필요 ≥ 1.0)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "S1",
                "note": "외인 -385,793→-265,265 / 기관 72,744→106,220 · 순매수 전환 없음",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "직전 30분봉 종가 698000, 전봉 종가 701000 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 691000,
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 698000, 전봉 종가 701000",
              "latestOpen": 702000.0,
              "latestClose": 698000.0,
              "previousClose": 701000.0
            },
            "toss": {
              "avgStrength": 119.0,
              "note": "토스 공개 체결강도 119.0% / 최근 체결 2분 프록시",
          ...
          },
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +37.0% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "20일 고점 대비 -4.8% (필요 -7%~-20%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 307,500 / 60MA 220,575",
                "evalStatus": "met"
              },
              {
                "code": "G4",
                "status": "⛔",
                "note": "최근 5거래일 최저 -2.3% (필요 -5% 이하 급락 1회 이상)",
                "evalStatus": "not_met"
              },
              {
                "code": "G5",
            ...
            "matchedRules": [
              {
                "code": "S1",
                "note": "외인 -3,419,695→1,891,734 / 기관 -307,631→1,513,469 · 순매수 전환",
                "evalStatus": "met"
              },
              {
                "code": "S2",
                "note": "당일 평균 94.0% / 마지막 1시간 230.2% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 307,500 / 20MA 268,875",
                "evalStatus": "met"
              },
              {
                "code": "C2",
                "note": "매수/매도 호가잔량 2.05 (필요 ≥ 1.0)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 312000, 전봉 종가 314500 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 307500,
            ...
            "entryPrice": 307500,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -4.8% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "기업 이벤트 필터는 미반영"
            ],
            "manualInput": {
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 312000, 전봉 종가 314500",
              "latestOpen": 315000.0,
              "latestClose": 312000.0,
              "previousClose": 314500.0
            },
            "toss": {
              "avgStrength": 94.0,
              "note": "토스 공개 체결강도 94.0% / 최근 체결 1분 프록시",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 5,270 / 60MA 4,302",
                "evalStatus": "met"
              },
              {
                "code": "G4",
                "status": "⛔",
                "note": "최근 5거래일 최저 -4.3% (필요 -5% 이하 급락 1회 이상)",
                "evalStatus": "not_met"
              },
              {
                "code": "G5-a",
            ...
            "matchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 94.8% / 마지막 1시간 212.5% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 5,270 / 20MA 4,868",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 476% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C2",
                "note": "매수/매도 호가잔량 1.27 (필요 ≥ 1.0)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "직전 30분봉 종가 5310, 전봉 종가 5305 충족",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "S1",
                "note": "외인 2,109,548→1,629,803 / 기관 107,910→229,604 · 순매수 전환 없음",
                "evalStatus": "not_met"
              },
              {
                "code": "P2",
            ...
            "dailyChangePct": 0.57,
            "dailyDirection": "up",
            "entryPriceText": "5,270원 (당일 종가 기준)",
            "entryPrice": 5270,
            "entryMeta": "당일 종가 기준",
              ...
              "fields": [
                {
                  ...
                  "copyHint": "실적 발표와 분할/합병/배당락까지 남은 일수만 입력하거나 차단을 체크합니다.",
                  "instructions": [
                    "KIND 공시에서 한온시스템 (018880) 종목 공시를 조회합니다.",
                    "실적 발표 예정일, 분할/합병/배당락 일정을 확인합니다.",
                    "남은 일수를 입력하거나 위험 이벤트가 임박했으면 차단을 체크합니다."
                  ]
                }
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 5310, 전봉 종가 5305",
              "latestOpen": 5300.0,
              "latestClose": 5310.0,
              "previousClose": 5305.0
            },
            "toss": {
              "avgStrength": 94.8,
              "note": "토스 공개 체결강도 94.8% / 최근 체결 2분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A018880/order",
              "asOf": "2026-05-27T06:08:09Z",
              "intradayAbove100Ratio": 100.0,
              "observedMinutes": 2,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 2분 프록시",
              "lastHourAvgStrength": 212.5,
              "lastHourObservedMinutes": 2
            },
            "orderbook": {
              "bidAskRatio": 1.2725,
              "bidTotal": 463652,
              "askTotal": 364354,
              "note": "토스 호가잔량합계 매수 463,652 / 매도 364,354",
              "source": "toss_quotes_api",
              "sourceUrl": "https://wts-info-api.tossinvest.com/api/v3/stock-prices/A018880/quotes?viewType=krx_all&investMode=krx"
            },
            "tradePlanRows": [
              {
                "stage": "🌅 프리마켓",
