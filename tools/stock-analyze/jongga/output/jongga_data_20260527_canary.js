  ...
  "dataQuality": {
    ...
    "collectionLog": [
      ...
      },
      {
        ...
        "status": "ok",
        "durationMs": 21176.4,
        "detail": "chrome:google-chrome · KIND 2",
        "count": 3
      }
    ],
        ...
        "pullback": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 1,987,000 > 20MA 1,727,950 > 60MA 1,239,867",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 2,257,000 / 60MA 1,239,867",
                "evalStatus": "met"
              },
              {
                "code": "G3",
              ...
              },
              {
                "code": "G5",
                "status": "⛔",
                "note": "KOSPI>7839.16, VKOSPI 71.45 · VKOSPI 과열",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "종가 2,257,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 2,182,000 ≤ 종가 2,257,000)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "P1",
                "note": "20일 고점 대비 -4.3% (필요 -7%~-15%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 234% (필요 100~180%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 -3.55% / KOSPI +2.84% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 2257000,
            "previousClose": 2052000,
            "dailyChange": 205000,
            "dailyChangePct": 9.99,
            "dailyDirection": "up",
            "entryPriceText": "2,257,000원 (당일 종가 기준)",
            "entryPrice": 2257000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 657,400 > 20MA 620,400 > 60MA 548,858",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 685,000 / 60MA 548,858",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "주봉 RSI 74.3 (필요 ≥ 50)",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "matchedRules": [
              {
                "code": "S2",
                "note": "외인 167,193주 / 기관 80,739주 · 당일 순매수",
                "evalStatus": "met"
              },
              {
                "code": "P1",
              ...
              {
                "code": "P2",
                "note": "종가 685,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "아래꼬리:몸통 1.19 (필요 ≥ 1.0)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "S1",
                "note": "거래대금 순위 13위 (TOP10 이내 시 S1 충족)",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 206% (필요 100~180%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 -3.19% / KOSPI +2.84% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 685000,
            ...
            "dailyChangePct": -0.58,
            "dailyDirection": "down",
            "entryPriceText": "685,000원 (당일 종가 기준)",
            "entryPrice": 685000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 156% (필요 100~180%)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 -5.92% / KOSPI +2.84% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 236000,
        ...
        "momentum": [
          {
            ...
            "dailyChangePct": 3.85,
            "dailyDirection": "up",
            "entryPriceText": "310,500원 (당일 종가 기준)",
            "entryPrice": 310500,
            "entryMeta": "당일 종가 기준",
            ...
            "orderbook": {
              ...
              "bidTotal": 239064,
              "askTotal": 112663,
              "note": "토스 호가잔량합계 매수 239,064 / 매도 112,663",
          ...
          },
          {
            ...
            "orderbook": {
              ...
              "bidTotal": 10387,
              "askTotal": 2844,
              "note": "토스 호가잔량합계 매수 10,387 / 매도 2,844",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "unmatchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 체결강도 119.0% · 100% 유지 비율 미입력",
                "evalStatus": "manual_required"
              },
              {
                "code": "C2",
                "note": "몸통 20% / 윗꼬리·몸통 1.46",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 693000,
            ...
            "dailyChangePct": 4.37,
            "dailyDirection": "up",
            "entryPriceText": "693,000원 (당일 종가 기준)",
            "entryPrice": 693000,
            "entryMeta": "당일 종가 기준",
            ...
            "toss": {
              "avgStrength": 119.0,
              "note": "토스 공개 체결강도 119.0% / 최근 체결 1분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A012330/order",
              "asOf": "2026-05-27T05:52:54Z",
              "intradayAbove100Ratio": 0.0,
              "observedMinutes": 1,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 1분 프록시",
              "lastHourAvgStrength": 62.7,
              "lastHourObservedMinutes": 1
            },
            "orderbook": {
              "bidAskRatio": 8.1578,
              "bidTotal": 36392,
              "askTotal": 4461,
              "note": "토스 호가잔량합계 매수 36,392 / 매도 4,461",
              "source": "toss_quotes_api",
        ...
        "reversal": [
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "⛔",
                "note": "1개월 수익률 +28.8% (필요 ≥ +30%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "20일 고점 대비 -11.6% (필요 -7%~-20%)",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "종가 685,000 / 20MA 620,400",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 206% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C2",
            ...
            "unmatchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 81.0% / 마지막 1시간 12.3% (필요 ≥90%·≥100%)",
                "evalStatus": "not_met"
              },
              {
                "code": "P2",
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 690000, 전봉 종가 690000 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 685000,
            ...
            "entryPrice": 685000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -11.6% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [],
            "manualInput": {
              "required": false,
              "fields": [],
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 690000, 전봉 종가 690000",
              "latestOpen": 690000.0,
              "latestClose": 690000.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 24695,
              "askTotal": 23299,
              "note": "토스 호가잔량합계 매수 24,695 / 매도 23,299",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +109.1% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "20일 고점 대비 -17.9% (필요 -7%~-20%)",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 11,460 / 60MA 6,040",
                "evalStatus": "met"
              },
              {
                "code": "G4",
                "status": "⛔",
                "note": "최근 5거래일 최저 -4.9% (필요 -5% 이하 급락 1회 이상)",
                "evalStatus": "not_met"
              },
              {
                "code": "G5-c",
            ...
            "matchedRules": [
              {
                "code": "S1",
                "note": "외인 348,112→-1,252,232 / 기관 -83,132→91,132 · 순매수 전환",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 11,460 / 20MA 7,438",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 300% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C2",
                "note": "매수/매도 호가잔량 2.59 (필요 ≥ 1.0)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 89.2% / 마지막 1시간 88.7% (필요 ≥90%·≥100%)",
                "evalStatus": "not_met"
              },
              {
                "code": "P2",
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 11710, 전봉 종가 11760 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 11460,
            ...
            "dailyChangePct": 4.95,
            "dailyDirection": "up",
            "entryPriceText": "11,460원 (당일 종가 기준)",
            "entryPrice": 11460,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -17.9% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [],
            "manualInput": {
              "required": false,
              "fields": [],
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 11710, 전봉 종가 11760",
              "latestOpen": 11710.0,
              "latestClose": 11710.0,
              "previousClose": 11760.0
            },
            "toss": {
              "avgStrength": 89.2,
              "note": "토스 공개 체결강도 89.2% / 최근 체결 1분 프록시",
              "source": "toss_http_combo",
            ...
            "orderbook": {
              ...
              "bidTotal": 59118,
              "askTotal": 22786,
              "note": "토스 호가잔량합계 매수 59,118 / 매도 22,786",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "matchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 94.7% / 마지막 1시간 123.6% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 5,290 / 20MA 4,869",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 471% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C2",
                "note": "매수/매도 호가잔량 2.26 (필요 ≥ 1.0)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 5320, 전봉 종가 5310 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 5290,
            ...
            "dailyChangePct": 0.95,
            "dailyDirection": "up",
            "entryPriceText": "5,290원 (당일 종가 기준)",
            "entryPrice": 5290,
            "entryMeta": "당일 종가 기준",
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 5320, 전봉 종가 5310",
              "latestOpen": 5320.0,
              "latestClose": 5320.0,
              "previousClose": 5310.0
            },
            "toss": {
              "avgStrength": 94.7,
              "note": "토스 공개 체결강도 94.7% / 최근 체결 1분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A018880/order",
              "asOf": "2026-05-27T05:52:56Z",
              "intradayAbove100Ratio": 100.0,
              "observedMinutes": 1,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 1분 프록시",
              "lastHourAvgStrength": 123.6,
              "lastHourObservedMinutes": 1
            },
            "orderbook": {
              "bidAskRatio": 2.2649,
              "bidTotal": 509676,
              "askTotal": 225032,
              "note": "토스 호가잔량합계 매수 509,676 / 매도 225,032",
              "source": "toss_quotes_api",
