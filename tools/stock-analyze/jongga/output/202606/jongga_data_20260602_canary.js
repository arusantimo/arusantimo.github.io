        ...
        "breakout": [
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 1.0,
                "evalStatus": "not_met",
                "note": "몸통 31% / 윗꼬리·몸통 0.00 (필요: 몸통 ≥70%, 윗꼬리·몸통 ≤0.3)"
              },
              {
                "code": "C3",
                "strictPoints": 1.0,
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "5일 초과 +87.1% / 20일 초과 +107.3%",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "52주 고가 대비 88.8% (필요 ≥ 90%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
              ...
              },
              {
                "code": "G6",
                "status": "⛔",
                "note": "당일 등락 +29.95% (필요 ≤ +12%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G7",
                "status": "✅",
                "note": "종가 158,800 / 5MA 106,740 (전일 5MA 91,980) · 5MA 위·우상향",
                "evalStatus": "met"
              }
            ],
            "matchedRules": [
            ...
            "dailyDirection": "up",
            "entryPriceText": "158,800원 (당일 종가 기준)",
            "entryPrice": 158800,
            "entryMeta": "당일 종가 기준",
            ...
            "volatilityContext": {
              ...
              "reason": "시장 고변동성 / 종목 고변동성 → 혼합 고변동성. 고변동성 장세라 실패 돌파·윗꼬리 위험이 커 불리합니다. VKOSPI 73.44, ATR10 14.86%, 일간 표준편차 12.34%, 당일 레인지 19.48%.",
              "metrics": {
                "atrPct10": 14.86,
                "returnStd20": 12.34,
                "todayRangePct": 19.48,
            ...
            "recommendedEntryBand": {
              ...
              "high": 158800,
              "anchor": 158800,
              "label": "157,212~158,800원 (종가 ±, 분할매수)"
            },
            "recommendedStage": {
              "stageKey": "intraday2",
              "evBasis": "historical:hitRateXTarget",
            ...
            "setupQuality": "setup_weak",
            "statusReasonShort": "G2 미충족: 52주 고가 대비 88.8% (필요 ≥ 90%) · 외 1건",
            "statusReason": "G2 미충족: 52주 고가 대비 88.8% (필요 ≥ 90%) / G6 미충족: 당일 등락 +29.95% (필요 ≤ +12%)"
          }
        ],
        "accumulation": [
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 1.5,
                "evalStatus": "met",
                "note": "5MA 2,317,600 / 20MA 1,935,950 · 5MA > 20MA"
              },
              {
                "code": "C1",
                "strictPoints": 1.0,
            ...
            "volatilityContext": {
              ...
              "reason": "시장 고변동성 / 종목 고변동성 → 혼합 고변동성. 고변동성 장세에서는 조용한 매집 구간이 상대적으로 유리합니다. VKOSPI 73.44, ATR10 6.55%, 일간 표준편차 5.54%, 당일 레인지 6.26%.",
              "metrics": {
                "atrPct10": 6.55,
                "returnStd20": 5.54,
                "todayRangePct": 6.26,
          ...
          },
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 1.5,
                "evalStatus": "met",
                "note": "5MA 732,400 / 20MA 605,825 · 5MA > 20MA"
              },
              {
                "code": "C1",
                "strictPoints": 1.0,
            ...
            "volatilityContext": {
              ...
              "scoreDelta": 0.75,
              "summary": "유리 (고변동성 장세에서는 조용한 매집 구간이 상대적으로 유리합니다)",
              "reason": "시장 고변동성 / 종목 고변동성 → 혼합 고변동성. 고변동성 장세에서는 조용한 매집 구간이 상대적으로 유리합니다. VKOSPI 73.44, ATR10 11.61%, 일간 표준편차 8.43%, 당일 레인지 10.12%.",
              "metrics": {
                "atrPct10": 11.61,
                "returnStd20": 8.43,
                "todayRangePct": 10.12,
          ...
          },
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 1.5,
                "evalStatus": "not_met",
                "note": "5MA 152,560 / 20MA 155,450 · 정배열 미충족"
              },
              {
                "code": "C1",
                "strictPoints": 1.0,
            ...
            "currentPrice": 156600,
            "previousClose": 152100,
            "dailyChange": 4500,
            "dailyChangePct": 2.96,
            "dailyDirection": "up",
            "entryPriceText": "156,600원 (당일 종가 기준)",
            "entryPrice": 156600,
            "entryMeta": "당일 종가 기준",
            ...
            "volatilityContext": {
              ...
              "scoreDelta": 0.75,
              "summary": "유리 (고변동성 장세에서는 조용한 매집 구간이 상대적으로 유리합니다)",
              "reason": "시장 고변동성 / 종목 중립 변동성 → 혼합 고변동성. 고변동성 장세에서는 조용한 매집 구간이 상대적으로 유리합니다. VKOSPI 73.44, ATR10 3.92%, 일간 표준편차 1.87%, 당일 레인지 4.54%.",
              "metrics": {
                "atrPct10": 3.92,
                "returnStd20": 1.87,
                "todayRangePct": 4.54,
            ...
            "recommendedEntryBand": {
              ...
              "high": 156600,
              "anchor": 156600,
              "label": "155,034~156,600원 (종가 ±, 분할매수)"
            },
            "recommendedStage": {
              "stageKey": "openPhase",
              "evBasis": "heuristic",
        ...
        "reversal": [
          {
            ...
            "filters": [
              ...
              },
              {
                "code": "F4",
                "status": "✅",
                "note": "최근 5거래일(2026-05-23~) 동일 종목 반등 진입 이력 없음 · 자동 확인",
                "evalStatus": "met"
              }
            ],
            "gates": [
          ...
          },
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 1.5,
                "evalStatus": "met",
                "note": "종가 1,813,000 / 20MA 1,260,050 (143.9% · 필요 ≥ 98%) · 20MA 근접 회복"
              },
              {
                "code": "P2",
                "strictPoints": 1.5,
            ...
            "gates": [
              ...
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 1,813,000 / 60MA 782,383",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "previousClose": 2005000,
            "dailyChange": -192000,
            "dailyChangePct": -9.58,
            "dailyDirection": "down",
            "entryPriceText": "1,813,000원 (당일 종가 기준)",
            "entryPrice": 1813000,
            "entryMeta": "당일 종가 기준",
            ...
            "volatilityContext": {
              ...
              "scoreDelta": 1.0,
              "summary": "유리 (고변동성 장세에서는 급락 반등 기회가 늘어 유리합니다)",
              "reason": "시장 고변동성 / 종목 고변동성 → 혼합 고변동성. 고변동성 장세에서는 급락 반등 기회가 늘어 유리합니다. VKOSPI 73.44, ATR10 13.74%, 일간 표준편차 7.36%, 당일 레인지 11.32%.",
              "metrics": {
                "atrPct10": 13.74,
                "returnStd20": 7.36,
                "todayRangePct": 11.32,
            ...
            "recommendedEntryBand": {
              ...
              "high": 1813000,
              "anchor": 1813000,
              "label": "1,794,870~1,813,000원 (종가 ±, 분할매수)"
            },
            "recommendedStage": {
              "stageKey": "openPhase",
              "evBasis": "historical:hitRateXTarget",
