...
window.JONGGA_CANARY_DAILY_DATA["2026-06-04"] = {
  ...
  "generatedAt": "2026-06-03T15:39:04+00:00",
  "variant": "canary",
  "dataQuality": {
    "status": "partial",
    "counts": {
        ...
        "pullback": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G5",
                "status": "⛔",
                "note": "KOSPI>8496.00, VKOSPI 73.60 · VKOSPI 과열",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
        ...
        "momentum": [
          {
            ...
            "matchedRules": [
              {
                "code": "S1",
                "note": "외인 88,259주 / 기관 66,473주 · 외인/기관 중 순매수",
                "evalStatus": "met"
              },
              {
                "code": "S2",
              ...
              {
                "code": "P2",
                "note": "당일 거래량 / 20일 평균 443% (필요 ≥ 150%)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "매수/매도 호가잔량 4.70 (필요 ≥ 1.2) · 매수 잔량 우위",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
            ...
            "entryPrice": 442500,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "상대강도 상위 여부와 돌파 지속성을 공개 데이터로 계산했습니다. 외인 88,259주 / 기관 66,473주.",
            "notes": [],
            "toss": {
              "avgStrength": 111.0,
        ...
        "reversal": [
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 1793% (필요 ≥ 200%) · 투매 클라이맥스",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "종가 16,690 / 20MA 14,007 (119.2% · 필요 ≥ 98%) · 20MA 근접 회복",
                "evalStatus": "met"
              },
              {
                "code": "P2",
