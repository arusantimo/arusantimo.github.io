        ...
        "pullback": [
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 2.0,
                "evalStatus": "not_met",
                "note": "거래량 44% (≥100% 만점·80~100% 부분) · 미충족"
              },
              {
                "code": "V1",
                "strictPoints": 0.75,
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "⛔",
                "note": "52주 고가 대비 -16.8% (≥12%) · 거래량 44% (≥80%) · 수급추세 +0 (≥0) · 반등 거래량 부족",
                "evalStatus": "not_met"
              },
              {
                "code": "G9",
            ...
            "statusReason": "G5 미충족: KOSPI 8,124 / 5MA 7,840 (+3.6%) · VKOSPI 89.9 · VKOSPI 과열 / Q1 미충족: 52주 고가 대비 -16.8% (≥12%) · 거래량 44% (≥80%) · 수급추세 +0 (≥0) · 반등 거래량 부족 / G12 미충족: 마지막 30분 비율 0.63:1 / 마지막 30분 평균 221.3% / 마지막 1시간 210.7% · 장 막판 투매 경고",
            "stockIndicators": {
              "snapshot": {
              ...
              "evaluatedAt": "2026-06-13T17:58:44+09:00",
          ...
          },
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 2.0,
                "evalStatus": "not_met",
                "note": "거래량 43% (≥100% 만점·80~100% 부분) · 미충족"
              },
              {
                "code": "V1",
                "strictPoints": 0.75,
            ...
            "scoreScope": "pullback",
            "statusLabel": "매매금지(핵심 Gate 미충족: G1, G2, G3, G4, G5, Q1)",
            "strategy": "pullback",
            "gates": [
              {
                "code": "G0",
              ...
              },
              {
                "code": "Q1",
                "status": "⛔",
                "note": "52주 고가 대비 -27.4% (≥12%) · 거래량 43% (≥80%) · 수급추세 +0 (≥0) · 반등 거래량 부족",
                "evalStatus": "not_met"
              },
              {
                "code": "G9",
            ...
            "entryBlockers": [
              ...
              "시장 Gate 차단: G5 — 신규 진입 보류",
              "핵심 Gate 미충족: Q1",
              "매매금지(핵심 Gate 미충족: G1, G2, G3, G4, G5, Q1)",
              "등급 C — 진입 최소 A, B, S"
            ],
            "setupQuality": "setup_weak",
            "statusReasonShort": "G1 미충족: 5MA 50,390 > 20MA 56,218 > 60MA 55,530 · 상승선 5MA, 60MA · 정배열 미충족 · 외 5건",
            "statusReason": "G1 미충족: 5MA 50,390 > 20MA 56,218 > 60MA 55,530 · 상승선 5MA, 60MA · 정배열 미충족 / G2 미충족: 종가 53,700 / 60MA 55,530 / G3 미충족: 주봉 RSI 48.6 (필요 ≥ 50) / 외 3건",
            "stockIndicators": {
              "snapshot": {
          ...
          },
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 2.5,
                "evalStatus": "met",
                "note": "52주 고가 대비 -24.8% (≥12% 만점·8~12% 부분) · 충족"
              },
              {
                "code": "D2",
                "strictPoints": 0.0,
              ...
              },
              {
                ...
                "maxPoints": 2.0,
                "evalStatus": "not_met",
                "note": "거래량 48% (≥100% 만점·80~100% 부분) · 미충족"
              },
              {
                "code": "V1",
                "strictPoints": 0.75,
            ...
            "scoreScope": "pullback",
            "statusLabel": "매매금지(핵심 Gate 미충족: G1, G4, G5, Q1)",
            "strategy": "pullback",
            "gates": [
              {
                "code": "G0",
              ...
              },
              {
                "code": "Q1",
                "status": "⛔",
                "note": "52주 고가 대비 -24.8% (≥12%) · 거래량 48% (≥80%) · 수급추세 +0 (≥0) · 반등 거래량 부족",
                "evalStatus": "not_met"
              },
              {
                "code": "G9",
            ...
            "entryBlockers": [
              ...
              "시장 Gate 차단: G5 — 신규 진입 보류",
              "핵심 Gate 미충족: Q1",
              "매매금지(핵심 Gate 미충족: G1, G4, G5, Q1)",
              "등급 C — 진입 최소 A, B, S"
            ],
            "setupQuality": "setup_weak",
            "statusReasonShort": "G1 미충족: 5MA 309,100 > 20MA 355,625 > 60MA 310,392 · 상승선 20MA, 60MA · 정배열 미충족 · 외 3건",
            "statusReason": "G1 미충족: 5MA 309,100 > 20MA 355,625 > 60MA 310,392 · 상승선 20MA, 60MA · 정배열 미충족 / G4 미충족: MACD 히스토그램 조건 미충족 / G5 미충족: KOSPI 8,124 / 5MA 7,840 (+3.6%) · VKOSPI 89.9 · VKOSPI 과열 / 외 1건",
            "stockIndicators": {
              "snapshot": {
        ...
        "accumulation": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "⛔",
                "note": "외인 보유율 6.9% (≥25%) · 20일 수익률 -3.8% (≥0%) · 외인 매집 주체 약함, 20일 약세(낙하 칼날)",
                "evalStatus": "not_met"
              },
              {
                "code": "G5",
            ...
            "setupQuality": "setup_weak",
            "statusReasonShort": "G1 미충족: 종가 42,800 / 60MA 44,733 · 외 2건",
            "statusReason": "G1 미충족: 종가 42,800 / 60MA 44,733 / Q1 미충족: 외인 보유율 6.9% (≥25%) · 20일 수익률 -3.8% (≥0%) · 외인 매집 주체 약함, 20일 약세(낙하 칼날) / G5 미충족: KOSPI 8,124 / 5MA 7,840 (+3.6%) · VKOSPI 89.9 · VKOSPI 과열",
            "stockIndicators": {
              "snapshot": {
              ...
              "evaluatedAt": "2026-06-12T23:58:35+09:00",
              "source": "jongga_analysis"
            },
            "stockExchangeName": "KOSDAQ"
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "✅",
                "note": "외인 보유율 47.6% (≥25%) · 20일 수익률 +34.5% (≥0%) · 매집 주체 존재+가격 지탱",
                "evalStatus": "met"
              },
              {
                "code": "G5",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "⛔",
                "note": "외인 보유율 23.2% (≥25%) · 20일 수익률 -11.4% (≥0%) · 외인 매집 주체 약함, 20일 약세(낙하 칼날)",
                "evalStatus": "not_met"
              },
              {
                "code": "G5",
            ...
            "setupQuality": "setup_weak",
            "statusReasonShort": "G1 미충족: 종가 106,500 / 60MA 110,953 · 외 2건",
            "statusReason": "G1 미충족: 종가 106,500 / 60MA 110,953 / Q1 미충족: 외인 보유율 23.2% (≥25%) · 20일 수익률 -11.4% (≥0%) · 외인 매집 주체 약함, 20일 약세(낙하 칼날) / G5 미충족: KOSPI 8,124 / 5MA 7,840 (+3.6%) · VKOSPI 89.9 · VKOSPI 과열",
            "stockIndicators": {
              "snapshot": {
