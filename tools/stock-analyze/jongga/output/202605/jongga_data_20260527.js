        ...
        "pullback": [
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 2.5,
                "evalStatus": "met",
                "note": "52주 고가 대비 -13.5% (≥12% 만점·8~12% 부분) · 충족"
              },
              {
                "code": "D2",
                "strictPoints": 0.0,
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "✅",
                "note": "52주 고가 대비 -13.5% (≥12%) · 거래량 82% (≥80%) · 수급추세 +0 (≥0) · 진짜 눌림+반등 거래량+수급 유지",
                "evalStatus": "met"
              },
              {
                "code": "G9",
          ...
          },
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 2.0,
                "evalStatus": "met",
                "note": "거래량 124% (≥100% 만점·80~100% 부분) · 충족"
              },
              {
                "code": "V1",
                "strictPoints": 0.75,
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "✅",
                "note": "52주 고가 대비 -25.1% (≥12%) · 거래량 124% (≥80%) · 수급추세 +0 (≥0) · 진짜 눌림+반등 거래량+수급 유지",
                "evalStatus": "met"
              },
              {
                "code": "G9",
          ...
          },
          {
            ...
            "scoreScope": "pullback",
            "statusLabel": "매매금지(핵심 Gate 미충족: G5, G8, Q1, G12)",
            "strategy": "pullback",
            "gates": [
              {
                "code": "G0",
              ...
              },
              {
                "code": "Q1",
                "status": "⛔",
                "note": "52주 고가 대비 -49.7% (≥12%) · 거래량 78% (≥80%) · 수급추세 +0 (≥0) · 반등 거래량 부족",
                "evalStatus": "not_met"
              },
              {
                "code": "G9",
            ...
            "entryBlockers": [
              ...
              "핵심 Gate 미충족: Q1",
              "핵심 Gate 미충족: G12",
              "매매금지(핵심 Gate 미충족: G5, G8, Q1, G12)",
              "등급 C — 진입 최소 A, B, S"
            ],
            "setupQuality": "setup_weak",
            "statusReasonShort": "G5 미충족: KOSPI 8,124 / 5MA 7,840 (+3.6%) · VKOSPI 89.9 · VKOSPI 과열 · 외 3건",
            "statusReason": "G5 미충족: KOSPI 8,124 / 5MA 7,840 (+3.6%) · VKOSPI 89.9 · VKOSPI 과열 / G8 미충족: 이격 20MA +27.9% (필요 ≤ +25%) · 60MA +68.4% (필요 ≤ +60%) · 과이격(지지선 눌림 아님) / Q1 미충족: 52주 고가 대비 -49.7% (≥12%) · 거래량 78% (≥80%) · 수급추세 +0 (≥0) · 반등 거래량 부족 / 외 1건",
            "stockIndicators": {
              "snapshot": {
        ...
        "accumulation": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "⛔",
                "note": "외인 보유율 6.9% (≥25%) · 20일 수익률 +3.6% (≥0%) · 외인 매집 주체 약함",
                "evalStatus": "not_met"
              },
              {
                "code": "G5",
            ...
            "setupQuality": "setup_weak",
            "statusReasonShort": "G1 미충족: 종가 44,150 / 60MA 44,826 · 외 2건",
            "statusReason": "G1 미충족: 종가 44,150 / 60MA 44,826 / Q1 미충족: 외인 보유율 6.9% (≥25%) · 20일 수익률 +3.6% (≥0%) · 외인 매집 주체 약함 / G5 미충족: KOSPI 8,124 / 5MA 7,840 (+3.6%) · VKOSPI 89.9 · VKOSPI 과열",
            "stockIndicators": {
              "snapshot": {
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "✅",
                "note": "외인 보유율 47.6% (≥25%) · 20일 수익률 +39.9% (≥0%) · 매집 주체 존재+가격 지탱",
                "evalStatus": "met"
              },
              {
                "code": "G5",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "⛔",
                "note": "외인 보유율 2.7% (≥25%) · 20일 수익률 -5.8% (≥0%) · 외인 매집 주체 약함, 20일 약세(낙하 칼날)",
                "evalStatus": "not_met"
              },
              {
                "code": "G5",
            ...
            "setupQuality": "setup_weak",
            "statusReasonShort": "G1 미충족: 종가 42,600 / 60MA 43,359 · 외 2건",
            "statusReason": "G1 미충족: 종가 42,600 / 60MA 43,359 / Q1 미충족: 외인 보유율 2.7% (≥25%) · 20일 수익률 -5.8% (≥0%) · 외인 매집 주체 약함, 20일 약세(낙하 칼날) / G5 미충족: KOSPI 8,124 / 5MA 7,840 (+3.6%) · VKOSPI 89.9 · VKOSPI 과열",
            "stockIndicators": {
              "snapshot": {
        ...
        "reversal": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "⛔",
                "note": "20MA 이격 +43.8% (≤+22%) · RSI14 84 (≤72) · 20MA 과이격(반등 소진), RSI 과매수",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
            ...
            "setupQuality": "setup_weak",
            "statusReasonShort": "G5 미충족: 양봉·긴아래꼬리·도지 패턴 없음 · 외 1건",
            "statusReason": "G5 미충족: 양봉·긴아래꼬리·도지 패턴 없음 / Q1 미충족: 20MA 이격 +43.8% (≤+22%) · RSI14 84 (≤72) · 20MA 과이격(반등 소진), RSI 과매수",
            "stockIndicators": {
              "snapshot": {
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "⛔",
                "note": "20MA 이격 +26.5% (≤+22%) · RSI14 72 (≤72) · 20MA 과이격(반등 소진)",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
            ...
            "statusReason": "F3 미충족: KIND 최근공시 2026-06-02 기업설명회(IR) 개최(안내공시) / G2 미충족: 20일 고점 대비 -4.8% (필요 -5%~-25%) / Q1 미충족: 20MA 이격 +26.5% (≤+22%) · RSI14 72 (≤72) · 20MA 과이격(반등 소진)",
            "stockIndicators": {
              "snapshot": {
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "Q1",
                "status": "⛔",
                "note": "20MA 이격 +44.0% (≤+22%) · RSI14 81 (≤72) · 20MA 과이격(반등 소진), RSI 과매수",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
            ...
            "setupQuality": "setup_weak",
            "statusReasonShort": "G2 미충족: 20일 고점 대비 +0.0% (필요 -5%~-25%) · 외 1건",
            "statusReason": "G2 미충족: 20일 고점 대비 +0.0% (필요 -5%~-25%) / Q1 미충족: 20MA 이격 +44.0% (≤+22%) · RSI14 81 (≤72) · 20MA 과이격(반등 소진), RSI 과매수",
            "stockIndicators": {
              "snapshot": {
                "currentPrice": 261500.0,
                "vs52wHighPct": 67.22365038560412,
