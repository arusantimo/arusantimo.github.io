        ...
        "breakout": [
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 1.0,
                "evalStatus": "met",
                "note": "몸통 84% / 윗꼬리·몸통 0.19 · 강마감 기준 충족"
              },
              {
                "code": "C3",
                "strictPoints": 1.0,
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "5일 초과 +60.1% / 20일 초과 +75.5%",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "52주 고가 대비 87.8% (필요 ≥ 90%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
              ...
              },
              {
                "code": "G6",
                "status": "⛔",
                "note": "당일 등락 +20.95% (필요 ≤ +12%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G7",
                "status": "✅",
                "note": "종가 224,000 / 5MA 189,360 (전일 5MA 172,600) · 5MA 위·우상향",
                "evalStatus": "met"
              }
            ],
            "matchedRules": [
            ...
            "volatilityContext": {
              ...
              "reason": "시장 고변동성 / 종목 고변동성 → 혼합 고변동성. 고변동성 장세라 실패 돌파·윗꼬리 위험이 커 불리합니다. VKOSPI 73.44, ATR10 20.19%, 일간 표준편차 9.76%, 당일 레인지 25.00%.",
              "metrics": {
                "atrPct10": 20.19,
                "returnStd20": 9.76,
                "todayRangePct": 25.0,
            ...
            "setupQuality": "setup_weak",
            "statusReasonShort": "G2 미충족: 52주 고가 대비 87.8% (필요 ≥ 90%) · 외 1건",
            "statusReason": "G2 미충족: 52주 고가 대비 87.8% (필요 ≥ 90%) / G6 미충족: 당일 등락 +20.95% (필요 ≤ +12%)"
          }
        ],
        "accumulation": [
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 1.5,
                "evalStatus": "met",
                "note": "5MA 1,842,200 / 20MA 1,634,850 · 5MA > 20MA"
              },
              {
                "code": "C1",
                "strictPoints": 1.0,
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "종가 1,941,000 / 60MA 1,203,333",
                "evalStatus": "met"
              },
              {
                "code": "G2",
            ...
            "volatilityContext": {
              ...
              "reason": "시장 고변동성 / 종목 고변동성 → 혼합 고변동성. 고변동성 장세에서는 조용한 매집 구간이 상대적으로 유리합니다. VKOSPI 73.44, ATR10 8.03%, 일간 표준편차 5.50%, 당일 레인지 2.06%.",
              "metrics": {
                "atrPct10": 8.03,
                "returnStd20": 5.5,
                "todayRangePct": 2.06,
            ...
            "recommendedEntryBand": {
              ...
              "high": 1941000,
              "anchor": 1941000,
              "label": "1,921,590~1,941,000원 (종가 ±, 분할매수)"
            },
            "recommendedStage": {
              "stageKey": "openPhase",
              "evBasis": "heuristic",
          ...
          },
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 1.5,
                "evalStatus": "met",
                "note": "5MA 1,101,200 / 20MA 1,013,950 · 5MA > 20MA"
              },
              {
                "code": "C1",
                "strictPoints": 1.0,
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "종가 1,185,000 / 60MA 725,800",
                "evalStatus": "met"
              },
              {
                "code": "G2",
            ...
            "previousClose": 1179000,
            "dailyChange": 6000,
            "dailyChangePct": 0.51,
            "dailyDirection": "up",
            "entryPriceText": "1,185,000원 (당일 종가 기준)",
            "entryPrice": 1185000,
            "entryMeta": "당일 종가 기준",
            ...
            "volatilityContext": {
              ...
              "scoreDelta": 0.75,
              "summary": "유리 (고변동성 장세에서는 조용한 매집 구간이 상대적으로 유리합니다)",
              "reason": "시장 고변동성 / 종목 고변동성 → 혼합 고변동성. 고변동성 장세에서는 조용한 매집 구간이 상대적으로 유리합니다. VKOSPI 73.44, ATR10 9.01%, 일간 표준편차 6.28%, 당일 레인지 4.24%.",
              "metrics": {
                "atrPct10": 9.01,
                "returnStd20": 6.28,
                "todayRangePct": 4.24,
            ...
            "recommendedEntryBand": {
              ...
              "high": 1185000,
              "anchor": 1185000,
              "label": "1,173,150~1,185,000원 (종가 ±, 분할매수)"
            },
            "recommendedStage": {
              "stageKey": "openPhase",
              "evBasis": "heuristic",
          ...
          },
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 1.5,
                "evalStatus": "met",
                "note": "5MA 636,000 / 20MA 603,950 · 5MA > 20MA"
              },
              {
                "code": "C1",
                "strictPoints": 1.0,
            ...
            "volatilityContext": {
              ...
              "scoreDelta": 0.75,
              "summary": "유리 (고변동성 장세에서는 조용한 매집 구간이 상대적으로 유리합니다)",
              "reason": "시장 고변동성 / 종목 고변동성 → 혼합 고변동성. 고변동성 장세에서는 조용한 매집 구간이 상대적으로 유리합니다. VKOSPI 73.44, ATR10 9.26%, 일간 표준편차 5.13%, 당일 레인지 3.75%.",
              "metrics": {
                "atrPct10": 9.26,
                "returnStd20": 5.13,
                "todayRangePct": 3.75,
        ...
        "reversal": [
          {
            ...
            "orderbook": {
              ...
              "bidTotal": 7366,
              "askTotal": 4522,
              "note": "토스 호가잔량합계 매수 7,366 / 매도 4,522",
          ...
          },
          {
            ...
            "orderbook": {
              ...
              "bidTotal": 7109,
              "askTotal": 2093,
              "note": "토스 호가잔량합계 매수 7,109 / 매도 2,093",
              "source": "toss_quotes_api",
            ...
            "volatilityContext": {
              ...
              "scoreDelta": 1.0,
              "summary": "유리 (고변동성 장세에서는 급락 반등 기회가 늘어 유리합니다)",
              "reason": "시장 고변동성 / 종목 고변동성 → 혼합 고변동성. 고변동성 장세에서는 급락 반등 기회가 늘어 유리합니다. VKOSPI 73.44, ATR10 10.68%, 일간 표준편차 4.44%, 당일 레인지 6.80%.",
              "metrics": {
                "atrPct10": 10.68,
                "returnStd20": 4.44,
                "todayRangePct": 6.8,
          ...
          },
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 1.5,
                "evalStatus": "met",
                "note": "종가 106,600 / 20MA 104,135 (102.4% · 필요 ≥ 98%) · 20MA 근접 회복"
              },
              {
                "code": "P2",
                "strictPoints": 1.5,
            ...
            "gates": [
              ...
              },
              {
                "code": "G4",
                "status": "✅",
                "note": "최근 5거래일 최저 -15.1% (필요 -3% 이하 급락 1회 이상)",
                "evalStatus": "met"
              },
              {
                "code": "G5-a",
            ...
            "volatilityContext": {
              ...
              "scoreDelta": 1.0,
              "summary": "유리 (고변동성 장세에서는 급락 반등 기회가 늘어 유리합니다)",
              "reason": "시장 고변동성 / 종목 고변동성 → 혼합 고변동성. 고변동성 장세에서는 급락 반등 기회가 늘어 유리합니다. VKOSPI 73.44, ATR10 12.42%, 일간 표준편차 7.20%, 당일 레인지 4.37%.",
              "metrics": {
                "atrPct10": 12.42,
                "returnStd20": 7.2,
                "todayRangePct": 4.37,
