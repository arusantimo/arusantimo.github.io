        ...
        "pullback": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 1,701,400 > 20MA 1,151,550 > 60MA 731,300",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 2,116,000 / 60MA 731,300",
                "evalStatus": "met"
              },
              {
                "code": "G3",
              ...
              },
              {
                "code": "G5",
                "status": "⚠️",
                "note": "KOSPI>8152.08, VKOSPI 73.95 · 거시·레짐 완화",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "종가 2,116,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 1,876,000 ≤ 종가 2,116,000)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 +7.78% / KOSPI +3.25% outperform",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
            ...
            "dailyChange": 267000,
            "dailyChangePct": 14.44,
            "dailyDirection": "up",
            "entryPriceText": "2,116,000원 (당일 종가 기준)",
            "entryPrice": 2116000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 1,113,800 > 20MA 800,100 > 60MA 493,975",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 1,459,000 / 60MA 493,975",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "종가 1,459,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 1,172,000 ≤ 종가 1,459,000)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 +5.41% / KOSPI +3.25% outperform",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "P1",
                "note": "20일 고점 대비 -0.4% (필요 -7%~-15%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 399% (필요 100~180%)",
                "evalStatus": "not_met"
              }
            ],
            ...
            "dailyChange": 325000,
            "dailyChangePct": 28.66,
            "dailyDirection": "up",
            "entryPriceText": "1,459,000원 (당일 종가 기준)",
            "entryPrice": 1459000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "⛔",
                "note": "5MA 208,160 > 20MA 206,695 > 60MA 210,440 · 정배열 또는 5MA 5일 상승 미충족",
                "evalStatus": "not_met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 234,000 / 60MA 210,440",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "종가 234,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 209,500 ≤ 종가 234,000)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 +5.52% / KOSPI +3.25% outperform",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "P1",
                "note": "20일 고점 대비 -5.5% (필요 -7%~-15%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 1381% (필요 100~180%)",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 234000,
            ...
            "dailyChange": 29000,
            "dailyChangePct": 14.15,
            "dailyDirection": "up",
            "entryPriceText": "234,000원 (당일 종가 기준)",
            "entryPrice": 234000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "5일 초과 +66.0% / 20일 초과 +125.6%",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "52주 고가 대비 99.6% (필요 ≥ 92%)",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "20일 고점 대비 99.6% (필요 ≥ 95%)",
                "evalStatus": "met"
              },
              {
                "code": "P2",
                "note": "당일 거래량 / 20일 평균 619% (필요 ≥ 150%)",
                "evalStatus": "met"
              },
              {
                "code": "C1",
            ...
            "unmatchedRules": [
              {
                "code": "S1",
                "note": "외인 -145,357주 / 기관 83,662주 · 동시 순매수 아님",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
            ...
            "entryPrice": 1459000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "상대강도 상위 여부와 돌파 지속성을 공개 데이터로 계산했습니다. 외인 -145,357주 / 기관 83,662주.",
            "notes": [],
            "toss": {
              "avgStrength": 111.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 1901,
              "askTotal": 6869,
              "note": "토스 호가잔량합계 매수 1,901 / 매도 6,869",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "5일 초과 +7.2% / 20일 초과 +45.7%",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "52주 고가 대비 97.2% (필요 ≥ 92%)",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "matchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 123.0% / 100% 유지 100.0% (필요 ≥110%·≥70%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
            ...
            "unmatchedRules": [
              {
                "code": "S1",
                "note": "외인 -534,089주 / 기관 101,307주 · 동시 순매수 아님",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "몸통 69% / 윗꼬리·몸통 0.35",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 773000,
            ...
            "entryPrice": 773000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "상대강도 상위 여부와 돌파 지속성을 공개 데이터로 계산했습니다. 외인 -534,089주 / 기관 101,307주.",
            "notes": [],
            "toss": {
              "avgStrength": 123.0,
              "note": "토스 공개 체결강도 123.0% / 최근 체결 1분 프록시",
              "source": "toss_http_combo",
            ...
            "orderbook": {
              ...
              "bidTotal": 45104,
              "askTotal": 4413,
              "note": "토스 호가잔량합계 매수 45,104 / 매도 4,413",
              "source": "toss_quotes_api",
        ...
        "reversal": [
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +166.5% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "20일 고점 대비 -3.5% (필요 -7%~-20%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 99.0% / 마지막 1시간 274.4% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 2,116,000 / 20MA 1,151,550",
                "evalStatus": "met"
              },
              {
                "code": "P2",
            ...
            "unmatchedRules": [
              {
                "code": "C2",
                "note": "매수/매도 호가잔량 0.77 (필요 ≥ 1.0)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "직전 30분봉 종가 2132000, 전봉 종가 2130000 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 2116000,
            ...
            "entryPrice": 2116000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -3.5% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "기업 이벤트 필터는 미반영"
            ],
            "manualInput": {
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 2132000, 전봉 종가 2130000",
              "latestOpen": 2132000.0,
              "latestClose": 2132000.0,
              "previousClose": 2130000.0
            },
            "toss": {
              "avgStrength": 99.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 2595,
              "askTotal": 3354,
              "note": "토스 호가잔량합계 매수 2,595 / 매도 3,354",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +172.2% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "20일 고점 대비 -0.4% (필요 -7%~-20%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 111.0% / 마지막 1시간 173.6% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 1,459,000 / 20MA 800,100",
                "evalStatus": "met"
              },
              {
                "code": "P2",
            ...
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 1446000, 전봉 종가 1449000 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 1459000,
            ...
            "entryPrice": 1459000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -0.4% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "기업 이벤트 필터는 미반영"
            ],
            "manualInput": {
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 1446000, 전봉 종가 1449000",
              "latestOpen": 1446000.0,
              "latestClose": 1446000.0,
              "previousClose": 1449000.0
            },
            "toss": {
              "avgStrength": 111.0,
              "note": "토스 공개 체결강도 111.0% / 최근 체결 1분 프록시",
          ...
          },
          {
            ...
            "filters": [
              {
                "code": "F1",
                "status": "✅",
                "note": "거래대금 TOP40 순위 39",
                "evalStatus": "met"
              },
              {
                "code": "F2",
                "status": "✅",
                "note": "시총 107.1조 (필요 ≥ 30조)",
                "evalStatus": "met"
              },
              {
                "code": "F3",
            ...
            "matchedRules": [
              {
                "code": "S1",
                "note": "외인 9,293→93,867 / 기관 -133,742→67,317 · 순매수 전환",
                "evalStatus": "met"
              },
              {
                "code": "S2",
                "note": "당일 평균 125.0% / 마지막 1시간 277.2% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 457,500 / 20MA 436,075",
                "evalStatus": "met"
              },
              {
                "code": "P2",
            ...
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 459000, 전봉 종가 458500 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 457500,
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 459000, 전봉 종가 458500",
              "latestOpen": 459000.0,
              "latestClose": 459000.0,
              "previousClose": 458500.0
            },
            "toss": {
              "avgStrength": 125.0,
              "note": "토스 공개 체결강도 125.0% / 최근 체결 1분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A373220/order",
              "asOf": "2026-05-29T05:52:46Z",
              "intradayAbove100Ratio": 100.0,
              "observedMinutes": 1,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 1분 프록시",
              "lastHourAvgStrength": 277.2,
              "lastHourObservedMinutes": 1
            },
            "orderbook": {
              "bidAskRatio": 0.3394,
              "bidTotal": 5163,
              "askTotal": 15211,
              "note": "토스 호가잔량합계 매수 5,163 / 매도 15,211",
              "source": "toss_quotes_api",
