        ...
        "pullback": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 1,987,400 > 20MA 1,728,050 > 60MA 1,239,900",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 2,259,000 / 60MA 1,239,900",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "주봉 RSI 84.8 (필요 ≥ 50)",
                "evalStatus": "met"
              },
              {
                "code": "G4",
              ...
              },
              {
                "code": "G5",
                "status": "⛔",
                "note": "KOSPI>7838.57, VKOSPI 71.50 · VKOSPI 과열",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "종가 2,259,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 2,182,000 ≤ 종가 2,259,000)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "P1",
                "note": "20일 고점 대비 -4.2% (필요 -7%~-15%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 233% (필요 100~180%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 -3.93% / KOSPI +2.80% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 2259000,
            "previousClose": 2052000,
            "dailyChange": 207000,
            "dailyChangePct": 10.09,
            "dailyDirection": "up",
            "entryPriceText": "2,259,000원 (당일 종가 기준)",
            "entryPrice": 2259000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 657,600 > 20MA 620,450 > 60MA 548,875",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 686,000 / 60MA 548,875",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "종가 686,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "아래꼬리:몸통 1.33 (필요 ≥ 1.0)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              ...
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 205% (필요 100~180%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 -3.19% / KOSPI +2.80% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 686000,
            ...
            "dailyChangePct": -0.44,
            "dailyDirection": "down",
            "entryPriceText": "686,000원 (당일 종가 기준)",
            "entryPrice": 686000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 -5.93% / KOSPI +2.80% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 236000,
        ...
        "momentum": [
          {
            ...
            "toss": {
              ...
              "asOf": "2026-05-27T05:51:40Z",
              "intradayAbove100Ratio": 100.0,
              "observedMinutes": 1,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 1분 프록시",
              "lastHourAvgStrength": 146.4,
            ...
            "orderbook": {
              ...
              "bidTotal": 234408,
              "askTotal": 116625,
              "note": "토스 호가잔량합계 매수 234,408 / 매도 116,625",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "5일 초과 +15.7% / 20일 초과 +57.1%",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "52주 고가 대비 95.8% (필요 ≥ 92%)",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "orderbook": {
              ...
              "bidTotal": 2124,
              "askTotal": 1457,
              "note": "토스 호가잔량합계 매수 2,124 / 매도 1,457",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "unmatchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 체결강도 120.0% · 100% 유지 비율 미입력",
                "evalStatus": "manual_required"
              },
              {
                "code": "C2",
                "note": "몸통 24% / 윗꼬리·몸통 1.00",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 696000,
            ...
            "orderbook": {
              ...
              "bidTotal": 35056,
              "askTotal": 4380,
              "note": "토스 호가잔량합계 매수 35,056 / 매도 4,380",
              "source": "toss_quotes_api",
        ...
        "reversal": [
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +37.9% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "20일 고점 대비 -4.2% (필요 -7%~-20%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 309,500 / 60MA 220,608",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 95.0% / 마지막 1시간 146.4% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 309,500 / 20MA 268,975",
                "evalStatus": "met"
              },
              {
                "code": "C2",
                "note": "매수/매도 호가잔량 2.01 (필요 ≥ 1.0)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 314500, 전봉 종가 314750 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 309500,
            ...
            "entryPrice": 309500,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -4.2% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "기업 이벤트 필터는 미반영"
            ],
            "manualInput": {
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 314500, 전봉 종가 314750",
              "latestOpen": 314500.0,
              "latestClose": 314500.0,
              "previousClose": 314750.0
            },
            "toss": {
              "avgStrength": 95.0,
              "note": "토스 공개 체결강도 95.0% / 최근 체결 1분 프록시",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G4",
                "status": "⛔",
                "note": "최근 5거래일 최저 +0.0% (필요 -5% 이하 급락 1회 이상)",
                "evalStatus": "not_met"
              },
              {
                "code": "G5-a",
            ...
            "matchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 104.0% / 마지막 1시간 112.8% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 2,259,000 / 20MA 1,728,050",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 233% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C2",
            ...
            "unmatchedRules": [
              {
                "code": "S1",
                "note": "외인 -158,042→-108,495 / 기관 152,990→386,967 · 순매수 전환 없음",
                "evalStatus": "not_met"
              },
              {
                "code": "P2",
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 2295000, 전봉 종가 2297000 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 2259000,
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 2295000, 전봉 종가 2297000",
              "latestOpen": 2295000.0,
              "latestClose": 2295000.0,
              "previousClose": 2297000.0
            },
            "toss": {
              "avgStrength": 104.0,
              "note": "토스 공개 체결강도 104.0% / 최근 체결 1분 프록시",
          ...
          },
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +109.3% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "20일 고점 대비 -17.8% (필요 -7%~-20%)",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 11,470 / 60MA 6,040",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "unmatchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 89.2% / 마지막 1시간 18.3% (필요 ≥90%·≥100%)",
                "evalStatus": "not_met"
              },
              {
                "code": "P2",
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 11790, 전봉 종가 11710 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 11470,
            ...
            "dailyChangePct": 5.04,
            "dailyDirection": "up",
            "entryPriceText": "11,470원 (당일 종가 기준)",
            "entryPrice": 11470,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -17.8% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [],
            "manualInput": {
              "required": false,
              "fields": [],
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 11790, 전봉 종가 11710",
              "latestOpen": 11790.0,
              "latestClose": 11790.0,
              "previousClose": 11710.0
            },
            "toss": {
              "avgStrength": 89.2,
            ...
            "orderbook": {
              ...
              "bidTotal": 56132,
              "askTotal": 15845,
              "note": "토스 호가잔량합계 매수 56,132 / 매도 15,845",
              "source": "toss_quotes_api",
