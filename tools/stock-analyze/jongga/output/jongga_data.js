        ...
        "pullback": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G5",
                "status": "⚠️",
                "note": "KOSPI>8152.20, VKOSPI 73.76 · 거시·레짐 완화",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 +8.32% / KOSPI +3.26% outperform",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 1,473,000 / 60MA 494,208",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "종가 1,473,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 1,172,000 ≤ 종가 1,473,000)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 +5.75% / KOSPI +3.26% outperform",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              ...
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 416% (필요 100~180%)",
                "evalStatus": "not_met"
              }
            ],
            ...
            "dailyChange": 339000,
            "dailyChangePct": 29.89,
            "dailyDirection": "up",
            "entryPriceText": "1,473,000원 (당일 종가 기준)",
            "entryPrice": 1473000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 127% (필요 100~180%)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 -2.15% / KOSPI +3.26% underperform",
                "evalStatus": "not_met"
              }
            ],
        ...
        "momentum": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "5일 초과 +13.0% / 20일 초과 +24.5%",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "52주 고가 대비 98.0% (필요 ≥ 92%)",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 115.0% / 100% 유지 100.0% (필요 ≥110%·≥70%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
              ...
              {
                "code": "P2",
                "note": "당일 거래량 / 20일 평균 1241% (필요 ≥ 150%)",
                "evalStatus": "met"
              },
              {
                "code": "C1",
            ...
            "dailyChange": 33200,
            "dailyChangePct": 28.67,
            "dailyDirection": "up",
            "entryPriceText": "149,000원 (당일 종가 기준)",
            "entryPrice": 149000,
            "entryMeta": "당일 종가 기준",
            ...
            "orderbook": {
              ...
              "bidTotal": 8532,
              "askTotal": 56563,
              "note": "토스 호가잔량합계 매수 8,532 / 매도 56,563",
          ...
          },
          {
            ...
            "unmatchedRules": [
              {
                "code": "P1",
                "note": "20일 고점 대비 94.6% (필요 ≥ 95%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "몸통 8% / 윗꼬리·몸통 5.75",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 684000,
            ...
            "orderbook": {
              ...
              "bidTotal": 12928,
              "askTotal": 8654,
              "note": "토스 호가잔량합계 매수 12,928 / 매도 8,654",
              "source": "toss_quotes_api",
        ...
        "reversal": [
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 144.0% / 마지막 1시간 128.1% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
            ...
            "toss": {
              "avgStrength": 144.0,
              "note": "토스 공개 체결강도 144.0% / 최근 체결 1분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A035420/order",
              "asOf": "2026-05-29T06:06:42Z",
              "intradayAbove100Ratio": 100.0,
              "observedMinutes": 1,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 1분 프록시",
              "lastHourAvgStrength": 128.1,
              "lastHourObservedMinutes": 1
            },
            "orderbook": {
              "bidAskRatio": 2.1862,
              "bidTotal": 89307,
              "askTotal": 40850,
              "note": "토스 호가잔량합계 매수 89,307 / 매도 40,850",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 114.0% / 마지막 1시간 175.0% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 1,473,000 / 20MA 800,800",
                "evalStatus": "met"
              },
              {
                "code": "P2",
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 1459000, 전봉 종가 1441000 충족",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 1459000, 전봉 종가 1441000",
              "latestOpen": 1441000.0,
              "latestClose": 1459000.0,
              "previousClose": 1441000.0
            },
            "toss": {
              "avgStrength": 114.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 2812,
              "askTotal": 12714,
              "note": "토스 호가잔량합계 매수 2,812 / 매도 12,714",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +56.0% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "20일 고점 대비 -2.0% (필요 -7%~-20%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 149,000 / 60MA 98,458",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "matchedRules": [
              ...
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 928% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "직전 30분봉 종가 145600, 전봉 종가 142600 충족",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
            ...
            "entryPrice": 149000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -2.0% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "기업 이벤트 필터는 미반영"
            ],
            "manualInput": {
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 145600, 전봉 종가 142600",
              "latestOpen": 142700.0,
              "latestClose": 145600.0,
