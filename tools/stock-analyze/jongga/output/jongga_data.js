        ...
        "pullback": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G5",
                "status": "⚠️",
                "note": "KOSPI>8485.16, VKOSPI 74.02 · 거시·레짐 완화",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
            ...
            "unmatchedRules": [
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 434% (필요 100~180%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 -2.96% / KOSPI -0.47% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 280000,
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 2,313,600 > 20MA 1,934,950 > 60MA 1,331,883",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 2,340,000 / 60MA 1,331,883",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 -2.31% / KOSPI -0.47% underperform",
                "evalStatus": "not_met"
              }
            ],
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 305,100 > 20MA 220,905 > 60MA 152,745",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 388,000 / 60MA 152,745",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "종가 388,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "아래꼬리:몸통 4.64 (필요 ≥ 1.0)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 -0.21% / KOSPI -0.47% outperform",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              ...
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 628% (필요 100~180%)",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 388000,
            ...
            "dailyChangePct": 1.97,
            "dailyDirection": "up",
            "entryPriceText": "388,000원 (당일 종가 기준)",
            "entryPrice": 388000,
            "entryMeta": "당일 종가 기준",
        ...
        "momentum": [
          {
            ...
            "matchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 116.9% / 100% 유지 100.0% (필요 ≥110%·≥70%)",
                "evalStatus": "met"
              },
              {
                "code": "P2",
                "note": "당일 거래량 / 20일 평균 571% (필요 ≥ 150%)",
                "evalStatus": "met"
              },
              {
                "code": "C1",
            ...
            "previousClose": 39450,
            "dailyChange": 8300,
            "dailyChangePct": 21.04,
            "dailyDirection": "up",
            "entryPriceText": "47,750원 (당일 종가 기준)",
            "entryPrice": 47750,
            "entryMeta": "당일 종가 기준",
            ...
            "toss": {
              "avgStrength": 116.9,
              "note": "토스 공개 체결강도 116.9% / 최근 체결 1분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A043260/order",
              "asOf": "2026-06-02T06:06:47Z",
            ...
            "orderbook": {
              ...
              "bidTotal": 13799,
              "askTotal": 18903,
              "note": "토스 호가잔량합계 매수 13,799 / 매도 18,903",
          ...
          },
          {
            ...
            "dailyChangePct": 2.87,
            "dailyDirection": "up",
            "entryPriceText": "359,000원 (당일 종가 기준)",
            "entryPrice": 359000,
            "entryMeta": "당일 종가 기준",
            ...
            "toss": {
              ...
              "asOf": "2026-06-02T06:06:45Z",
              "intradayAbove100Ratio": 0.0,
              "observedMinutes": 1,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 1분 프록시",
              "lastHourAvgStrength": 16.5,
              "lastHourObservedMinutes": 1
            },
            "orderbook": {
              "bidAskRatio": 1.6181,
              "bidTotal": 211408,
              "askTotal": 130653,
              "note": "토스 호가잔량합계 매수 211,408 / 매도 130,653",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "당일 거래량 / 20일 평균 1002% (필요 ≥ 150%)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
            ...
            "orderbook": {
              ...
              "bidTotal": 4958,
              "askTotal": 5700,
              "note": "토스 호가잔량합계 매수 4,958 / 매도 5,700",
              "source": "toss_quotes_api",
        ...
        "reversal": [
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "⛔",
                "note": "1개월 수익률 +27.3% (필요 ≥ +30%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "20일 고점 대비 -7.9% (필요 -7%~-20%)",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 100.0% / 마지막 1시간 283.8% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 280,000 / 20MA 212,720",
                "evalStatus": "met"
              },
              {
                "code": "P2",
              ...
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 434% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C2",
                "note": "매수/매도 호가잔량 1.03 (필요 ≥ 1.0)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "직전 30분봉 종가 282500, 전봉 종가 281500 충족",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
            ...
            "entryPrice": 280000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -7.9% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [],
            "manualInput": {
              "required": false,
              "fields": [],
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 282500, 전봉 종가 281500",
              "latestOpen": 281000.0,
              "latestClose": 282500.0,
              "previousClose": 281500.0
            },
            "toss": {
              "avgStrength": 100.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 55413,
              "askTotal": 53844,
              "note": "토스 호가잔량합계 매수 55,413 / 매도 53,844",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "⛔",
                "note": "1개월 수익률 +9.0% (필요 ≥ +30%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "20일 고점 대비 -5.4% (필요 -7%~-20%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 47,750 / 60MA 44,132",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 116.9% / 마지막 1시간 168.0% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 47,750 / 20MA 41,430",
                "evalStatus": "met"
              },
              {
                "code": "P2",
            ...
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 47250, 전봉 종가 48150 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 47750,
            ...
            "entryPrice": 47750,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -5.4% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "기업 이벤트 필터는 미반영"
            ],
            "manualInput": {
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 47250, 전봉 종가 48150",
              "latestOpen": 48175.0,
              "latestClose": 47250.0,
          ...
          },
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +59.5% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "20일 고점 대비 -3.7% (필요 -7%~-20%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 1,324,000 / 60MA 790,500",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "종가 1,324,000 / 20MA 1,153,100",
                "evalStatus": "met"
              },
              {
                "code": "P2",
              ...
              {
                "code": "C2",
                "note": "매수/매도 호가잔량 1.15 (필요 ≥ 1.0)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "직전 30분봉 종가 1352000, 전봉 종가 1325000 충족",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 105.0% / 마지막 1시간 26.0% (필요 ≥90%·≥100%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C1",
            ...
            "dailyChangePct": 5.41,
            "dailyDirection": "up",
            "entryPriceText": "1,324,000원 (당일 종가 기준)",
            "entryPrice": 1324000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -3.7% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "기업 이벤트 필터는 미반영"
            ],
            "manualInput": {
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 1352000, 전봉 종가 1325000",
              "latestOpen": 1325000.0,
              "latestClose": 1352000.0,
            ...
            "toss": {
              ...
              "asOf": "2026-06-02T06:06:48Z",
              "intradayAbove100Ratio": 0.0,
              "observedMinutes": 1,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 1분 프록시",
              "lastHourAvgStrength": 26.0,
              "lastHourObservedMinutes": 1
            },
            "orderbook": {
              "bidAskRatio": 1.1521,
              "bidTotal": 1530,
              "askTotal": 1328,
              "note": "토스 호가잔량합계 매수 1,530 / 매도 1,328",
              "source": "toss_quotes_api",
