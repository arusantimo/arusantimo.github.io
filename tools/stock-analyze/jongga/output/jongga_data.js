        ...
        "reversal": [
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 2.0,
                "evalStatus": "met",
                "note": "당일 평균 124.0% / 마지막 1시간 108.8% (필요 ≥90%·≥100%)"
              },
              {
                "code": "P1",
                "strictPoints": 1.5,
                ...
                "maxPoints": 1.5,
                "evalStatus": "met",
                "note": "종가 1,551,000 / 20MA 1,403,950 (110.5% · 필요 ≥ 98%) · 20MA 근접 회복"
              },
              {
                "code": "P2",
                "strictPoints": 1.5,
              ...
              },
              {
                ...
                "maxPoints": 1.0,
                "evalStatus": "met",
                "note": "직전 30분봉 종가 1546000, 전봉 종가 1541000 충족"
              },
              {
                "code": "V1",
                "strictPoints": 1.0,
            ...
            "gates": [
              ...
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 1,551,000 / 60MA 1,390,117",
                "evalStatus": "met"
              },
              {
                "code": "G4",
              ...
              },
              {
                "code": "Q1",
                "status": "✅",
                "note": "20MA 이격 +10.5% (≤+22%) · RSI14 65 (≤72) · 과이격·과매수 반등 아님",
                "evalStatus": "met"
              }
            ],
            "matchedRules": [
            ...
            "dailyChangePct": 2.17,
            "dailyDirection": "up",
            "entryPriceText": "1,551,000원 (당일 종가 기준)",
            "entryPrice": 1551000,
            "entryMeta": "당일 종가 기준",
            "marketCapTrillion": 71.7973,
            "marketCapRank": 7,
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 1546000, 전봉 종가 1541000",
              "latestOpen": 1542000.0,
              "latestClose": 1546000.0,
              "previousClose": 1541000.0
            },
            "toss": {
              "avgStrength": 124.0,
              "note": "토스 공개 체결강도 124.0% / 최근 체결 4분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A207940/order",
              "asOf": "2026-07-27T06:03:33Z",
              "intradayAbove100Ratio": 25.0,
              "observedMinutes": 4,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 4분 프록시",
              "lastHourAvgStrength": 108.8,
              "lastHourObservedMinutes": 4,
              "last30AvgStrength": 108.8,
              "last30ObservedMinutes": 4,
              "last30BuySellRatio": 0.474,
            ...
            "orderbook": {
              ...
              "bidTotal": 206,
              "askTotal": 744,
              "note": "Naver 호가잔량합계 매수 206 / 매도 744",
            ...
            "volatilityContext": {
              ...
              "reason": "시장 고변동성 / 종목 고변동성 → 혼합 고변동성. 고변동성 장세에서는 낙주 매매 기회가 늘어 유리합니다. VKOSPI 77.73, ATR10 5.26%, 일간 표준편차 3.64%, 당일 레인지 5.86%.",
              "metrics": {
                "atrPct10": 5.26,
                "returnStd20": 3.64,
                "todayRangePct": 5.86,
            ...
            "tradePlanRows": [
              ...
              },
              {
                "stage": "🛑 손절",
                "stageKey": "stop",
                "condition": "유효 하드 스톱 1,512,225원 종가 이탈",
                "quantity": "전량",
                "targetYield": "-2.5%",
                "targetPrice": "1,512,225원"
              }
            ],
            "reversalStopPolicy": {
              ...
              "fallbackStopPrice": 1512225,
              "effectiveHardStopPrice": 1512225,
              "stopExecutionMode": "close_only",
              "hardStopRuleSummary": "진입 당일 저가 1,486,000원와 기존 % 손절 1,512,225원 중 더 높은 1,512,225원을 종가 손절가로 사용합니다.",
              "reasonSummary": "반등 가정의 핵심 지지선은 진입 당일 저가 1,486,000원이며, 기존 % 손절 1,512,225원보다 느슨해지지 않게 1,512,225원으로 고정하고 종가 기준으로 확인합니다."
            },
            ...
            "recommendedEntryBand": {
              ...
              "high": 1538592,
              "anchor": 1551000,
              "label": "1,523,082~1,538,592원 (종가 ±, 분할매수)"
            },
            ...
            "statusReason": "G1 미충족: 1개월 수익률 +11.9% (필요 ≥ +15%) / G2 미충족: 20일 고점 대비 -1.5% (필요 -5%~-25%) / G4 미충족: 최근 5거래일 최저 -1.6% (필요 -3% 이하 급락 1회 이상)",
            "stockIndicators": {
              "snapshot": {
                "currentPrice": 1551000.0,
                "vs52wHighPct": 78.05737292400605,
                "vs52wLowPct": 26.302931596091206,
                "dropFrom52wHighPct": 21.94262707599396,
                "ma20GapPct": 10.474019730047367,
                "rsi14": 64.80453572402544,
                "volumeRatio20d": 157.00737801003243,
                "rs20Pct": 15.48771407297096,
