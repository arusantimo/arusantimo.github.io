window.JONGGA_DATA = {
  ...
  "dataQuality": {
    ...
    "failedKeys": [
      "orderbook 011070: <urlopen error [Errno 8] nodename nor servname provided, or not known>"
    ],
    "staleKeys": [],
    "manualKeys": [
      "toss_metrics",
          ...
          },
          {
            ...
            "scoreBreakdown": [
              ...
              },
              {
                ...
                "maxPoints": 1.0,
                "evalStatus": "met",
                "note": "매수/매도 호가잔량 1.89 (필요 ≥ 1.2) · 매수 잔량 우위"
              }
            ],
            "scoreScope": "breakout",
            "statusLabel": "매매금지(핵심 Gate 미충족)",
            ...
            "gates": [
              ...
              },
              {
                "code": "G7",
                "status": "✅",
                "note": "종가 1,361,000 / 5MA 1,286,600 (전일 5MA 1,269,600) · 5MA 위·우상향",
                "evalStatus": "met"
              }
            ],
            "matchedRules": [
            ...
            "entryPrice": 1361000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "주도주 돌파형 — RS·거래량·강마감·5MA 추세를 점검했습니다. 외인 34,734주 / 기관 4,593주.",
            "notes": [],
            "toss": {
              "avgStrength": 94.0,
