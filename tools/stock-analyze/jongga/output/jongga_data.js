        ...
        "pullback": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 1,286,800 > 20MA 1,172,750 > 60MA 804,350 · 상승선 5MA, 20MA, 60MA",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 1,362,000 / 60MA 804,350",
                "evalStatus": "met"
              },
              {
                "code": "G3",
              ...
              },
              {
                "code": "G5",
                "status": "⚠️",
                "note": "KOSPI>8584.10, VKOSPI 73.68 · 변동성 경계",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "종가 1,362,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 1,314,000 ≤ 종가 1,362,000)",
                "evalStatus": "met"
              },
              {
                "code": "C2",
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 +1.15% / KOSPI -1.50% outperform",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [],
            ...
            "dailyChangePct": 1.19,
            "dailyDirection": "up",
            "entryPriceText": "1,362,000원 (당일 종가 기준)",
            "entryPrice": 1362000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 746,600 > 20MA 622,200 > 60MA 482,317 · 상승선 5MA, 20MA, 60MA",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 759,000 / 60MA 482,317",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 +0.60% / KOSPI -1.50% outperform",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [],
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 +12.47% / KOSPI -1.50% outperform",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
        ...
        "momentum": [
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 117.2% / 100% 유지 100.0% (필요 ≥110%·≥70%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
            ...
            "dailyChangePct": 25.7,
            "dailyDirection": "up",
            "entryPriceText": "247,500원 (당일 종가 기준)",
            "entryPrice": 247500,
            "entryMeta": "당일 종가 기준",
            ...
            "toss": {
              "avgStrength": 117.2,
              "note": "토스 공개 체결강도 117.2% / 최근 체결 1분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A036930/order",
              "asOf": "2026-06-04T05:51:41Z",
            ...
            "orderbook": {
              ...
              "bidTotal": 15060,
              "askTotal": 69964,
              "note": "토스 호가잔량합계 매수 15,060 / 매도 69,964",
          ...
          },
          {
            ...
            "dailyChangePct": 4.98,
            "dailyDirection": "up",
            "entryPriceText": "164,400원 (당일 종가 기준)",
            "entryPrice": 164400,
            "entryMeta": "당일 종가 기준",
            ...
            "toss": {
              ...
              "asOf": "2026-06-04T05:51:44Z",
              "intradayAbove100Ratio": 100.0,
              "observedMinutes": 1,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 1분 프록시",
              "lastHourAvgStrength": 159.9,
              "lastHourObservedMinutes": 1
            },
            "orderbook": {
              "bidAskRatio": 1.0476,
              "bidTotal": 5721,
              "askTotal": 5461,
              "note": "토스 호가잔량합계 매수 5,721 / 매도 5,461",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "C3",
                "note": "매수/매도 호가잔량 3.82 (필요 ≥ 1.2) · 매수 잔량 우위",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              ...
              {
                "code": "P1",
                "note": "20일 고점 대비 78.9% (필요 ≥ 95%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C1",
                "note": "종가 / 당일 고가 90.9% (필요 ≥ 95%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "몸통 31% / 윗꼬리·몸통 2.19",
                "evalStatus": "not_met"
              }
            ],
            ...
            "dailyChangePct": -4.63,
            "dailyDirection": "down",
            "entryPriceText": "1,729,000원 (당일 종가 기준)",
            "entryPrice": 1729000,
            "entryMeta": "당일 종가 기준",
            ...
            "orderbook": {
              ...
              "bidTotal": 5532,
              "askTotal": 1447,
              "note": "토스 호가잔량합계 매수 5,532 / 매도 1,447",
              "source": "toss_quotes_api",
        ...
        "reversal": [
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 105.0% / 마지막 1시간 106.9% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
            ...
            "unmatchedRules": [
              {
                "code": "C3",
                "note": "직전 30분봉 종가 539000, 전봉 종가 536000 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 535000,
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 539000, 전봉 종가 536000",
              "latestOpen": 539000.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 4198,
              "askTotal": 2969,
              "note": "토스 호가잔량합계 매수 4,198 / 매도 2,969",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 117.2% / 마지막 1시간 119.8% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 247,500 / 20MA 182,290 (135.8% · 필요 ≥ 98%) · 20MA 근접 회복",
                "evalStatus": "met"
              },
              {
                "code": "P2",
            ...
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 244000, 전봉 종가 244000 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 247500,
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 244000, 전봉 종가 244000",
              "latestOpen": 244000.0,
              "latestClose": 244000.0,
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 102.6% / 마지막 1시간 300.0% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 51,300 / 20MA 41,810 (122.7% · 필요 ≥ 98%) · 20MA 근접 회복",
                "evalStatus": "met"
              },
              {
                "code": "P2",
            ...
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 51400, 전봉 종가 51300 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 51300,
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 51400, 전봉 종가 51300",
              "latestOpen": 51400.0,
              "latestClose": 51400.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 32229,
              "askTotal": 40554,
              "note": "토스 호가잔량합계 매수 32,229 / 매도 40,554",
              "source": "toss_quotes_api",
