        ...
        "pullback": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 2,317,600 > 20MA 1,935,950 > 60MA 1,332,217",
                "evalStatus": "met"
              },
              {
                "code": "G2",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 237,960 > 20MA 212,745 > 60MA 212,507",
                "evalStatus": "met"
              },
              {
                "code": "G2",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 1,884,800 > 20MA 1,260,050 > 60MA 782,383",
                "evalStatus": "met"
              },
              {
                "code": "G2",
            ...
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "저가 1,659,000 · 이평선 터치: 5MA",
                "evalStatus": "met"
              },
              {
                "code": "P2",
                "note": "종가 1,813,000 · 5MA·10MA·20MA 중 10MA, 20MA 위",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "C1",
                "note": "음봉 · 아래꼬리:몸통 0.73 (필요 ≥ 1.0)",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 181% (필요 ≤ 80%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 -5.30% / KOSPI +0.15% underperform",
                "evalStatus": "not_met"
              }
            ],
        ...
        "momentum": [
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "S1",
                "note": "외인 -416,517주 / 기관 90,158주 · 외인/기관 중 순매수",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "20일 고점 대비 98.0% (필요 ≥ 95%)",
                "evalStatus": "met"
              },
              {
                "code": "C1",
            ...
            "unmatchedRules": [
              ...
              {
                "code": "P2",
                "note": "당일 거래량 / 20일 평균 150% (필요 ≥ 150%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
                "note": "몸통 22% / 윗꼬리·몸통 1.02",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 2360000,
            ...
            "entryPrice": 2360000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "상대강도 상위 여부와 돌파 지속성을 공개 데이터로 계산했습니다. 외인 -416,517주 / 기관 90,158주.",
            "notes": [],
            "toss": {
              "avgStrength": 90.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 202,
              "askTotal": 66994,
              "note": "토스 호가잔량합계 매수 202 / 매도 66,994",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "matchedRules": [
              {
                "code": "S1",
                "note": "외인 496,315주 / 기관 409,960주 · 외인/기관 중 순매수",
                "evalStatus": "met"
              },
              {
                "code": "P2",
                "note": "당일 거래량 / 20일 평균 593% (필요 ≥ 150%)",
                "evalStatus": "met"
              },
              {
                "code": "C1",
              ...
              {
                "code": "C2",
                "note": "몸통 75% / 윗꼬리·몸통 0.28",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "매수/매도 호가잔량 0.58 (필요 ≤ 0.8)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 체결강도 117.3% · 100% 유지 비율 미입력",
                "evalStatus": "manual_required"
              },
              {
                "code": "P1",
                "note": "20일 고점 대비 94.1% (필요 ≥ 95%)",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 47500,
            "previousClose": 39450,
            "dailyChange": 8050,
            "dailyChangePct": 20.41,
            "dailyDirection": "up",
            "entryPriceText": "47,500원 (당일 종가 기준)",
            "entryPrice": 47500,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "상대강도 상위 여부와 돌파 지속성을 공개 데이터로 계산했습니다. 외인 496,315주 / 기관 409,960주.",
            "notes": [],
            "toss": {
              "avgStrength": 117.3,
              "note": "토스 공개 체결강도 117.3% / 최근 체결 134분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A043260/order",
              "asOf": "2026-06-02T09:00:13Z",
            ...
            "orderbook": {
              ...
              "bidTotal": 36529,
              "askTotal": 63286,
              "note": "토스 호가잔량합계 매수 36,529 / 매도 63,286",
              "source": "toss_quotes_api",
        ...
        "reversal": [
          {
            ...
            "filters": [
              {
                "code": "F1",
                "status": "✅",
                "note": "최근 20일 최대 거래량 급증 291% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "F2",
                "status": "✅",
                "note": "시총 103.5조 (필요 ≥ 30조)",
                "evalStatus": "met"
              },
              {
                "code": "F3",
            ...
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "종가 442,500 / 20MA 434,300",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 280% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C2",
                "note": "매수/매도 호가잔량 4.70 (필요 ≥ 1.0)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
          ...
          },
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +63.1% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "20일 고점 대비 -1.9% (필요 -7%~-20%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 94.0% / 마지막 1시간 143.3% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 166,700 / 20MA 110,230",
                "evalStatus": "met"
              },
              {
                "code": "P2",
            ...
            "unmatchedRules": [
              {
                "code": "S1",
                "note": "외인 741,633→-727,436 / 기관 31,559→62,982 · 순매수 전환 없음",
                "evalStatus": "not_met"
              },
              {
                "code": "C2",
              ...
              {
                "code": "C3",
                "note": "직전 30분봉 종가 166700, 전봉 종가 162400 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 166700,
            ...
            "entryPrice": 166700,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -1.9% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "기업 이벤트 필터는 미반영"
            ],
            "manualInput": {
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 166700, 전봉 종가 162400",
              "latestOpen": 166700.0,
              "latestClose": 166700.0,
              "previousClose": 162400.0
            },
            "toss": {
              "avgStrength": 94.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 3504,
              "askTotal": 48527,
              "note": "토스 호가잔량합계 매수 3,504 / 매도 48,527",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +34.3% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "20일 고점 대비 -7.0% (필요 -7%~-20%)",
                "evalStatus": "met"
              },
              {
                "code": "G3",
              ...
              },
              {
                "code": "G4",
                "status": "✅",
                "note": "최근 5거래일 최저 -9.6% (필요 -5% 이하 급락 1회 이상)",
                "evalStatus": "met"
              },
              {
                "code": "G5-a",
            ...
            "matchedRules": [
              {
                "code": "S1",
                "note": "외인 -6,182,291→5,772,300 / 기관 -712,454→122,809 · 순매수 전환",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 16,690 / 20MA 14,007",
                "evalStatus": "met"
              },
              {
                "code": "P2",
            ...
            "unmatchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 102.2% · 마지막 1시간 평균 미입력",
                "evalStatus": "manual_required"
              },
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 180% (필요 ≥ 200%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "직전 30분봉 종가 16690, 전봉 종가 16540 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 16690,
            ...
            "entryPrice": 16690,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -7.0% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "마지막 1시간 체결강도 미반영",
              "기업 이벤트 필터는 미반영"
            ],
              ...
              "fields": [
                {
                  ...
                  "sourceUrl": "https://www.tossinvest.com/stocks/A034220/chart",
                  "copyHint": "마감 전 최근 1시간 평균 체결강도만 붙여넣습니다.",
                  "instructions": [
                    "토스증권에서 LG디스플레이 (034220) 차트 화면을 엽니다.",
                ...
                },
                {
                  ...
                  "copyHint": "실적 발표와 분할/합병/배당락까지 남은 일수만 입력하거나 차단을 체크합니다.",
                  "instructions": [
                    "KIND 공시에서 LG디스플레이 (034220) 종목 공시를 조회합니다.",
                    "실적 발표 예정일, 분할/합병/배당락 일정을 확인합니다.",
                    "남은 일수를 입력하거나 위험 이벤트가 임박했으면 차단을 체크합니다."
                  ]
                }
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 16690, 전봉 종가 16540",
              "latestOpen": 16690.0,
              "latestClose": 16690.0,
              "previousClose": 16540.0
            },
            "toss": {
              "avgStrength": 102.2,
              "note": "토스 공개 체결강도 102.2% / 최근 체결 134분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A034220/order",
              "asOf": "2026-06-02T09:00:15Z",
              "intradayAbove100Ratio": 0.0,
              "observedMinutes": 134,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 134분 프록시"
            ...
            "orderbook": {
              ...
              "bidTotal": 151121,
              "askTotal": 121165,
              "note": "토스 호가잔량합계 매수 151,121 / 매도 121,165",
              "source": "toss_quotes_api",
              "sourceUrl": "https://wts-info-api.tossinvest.com/api/v3/stock-prices/A034220/quotes?viewType=krx_all&investMode=krx"
            },
            "tradePlanRows": [
              {
                "stage": "🌅 프리마켓",
