        ...
        "pullback": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "⛔",
                "note": "5MA 223,260 > 20MA 209,620 > 60MA 211,615 · 정배열 또는 5MA 5일 상승 미충족",
                "evalStatus": "not_met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 278,500 / 60MA 211,615",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "주봉 RSI 61.1 (필요 ≥ 50)",
                "evalStatus": "met"
              },
              {
                "code": "G4",
              ...
              },
              {
                "code": "G5",
                "status": "⚠️",
                "note": "KOSPI>8350.94, VKOSPI 74.03 · 거시·레짐 완화",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "20일 고점 대비 -8.4% (필요 -7%~-15%)",
                "evalStatus": "met"
              },
              {
                "code": "P2",
                "note": "종가 278,500 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 247,500 ≤ 종가 278,500)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 1244% (필요 100~180%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 -3.03% / KOSPI +4.02% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 278500,
            ...
            "dailyChange": 44500,
            "dailyChangePct": 19.02,
            "dailyDirection": "up",
            "entryPriceText": "278,500원 (당일 종가 기준)",
            "entryPrice": 278500,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 1,836,200 > 20MA 1,210,900 > 60MA 758,825",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 2,003,000 / 60MA 758,825",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "20일 고점 대비 -8.6% (필요 -7%~-15%)",
                "evalStatus": "met"
              },
              {
                "code": "P2",
                "note": "종가 2,003,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C2",
            ...
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 +1.06% / KOSPI +4.02% underperform",
                "evalStatus": "not_met"
              }
            ],
            ...
            "dailyChangePct": -5.83,
            "dailyDirection": "down",
            "entryPriceText": "2,003,000원 (당일 종가 기준)",
            "entryPrice": 2003000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 1,249,000 > 20MA 847,500 > 60MA 515,542",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 1,541,000 / 60MA 515,542",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "20일 고점 대비 -13.8% (필요 -7%~-15%)",
                "evalStatus": "met"
              },
              {
                "code": "P2",
                "note": "종가 1,541,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 1,480,000 ≤ 종가 1,541,000)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              ...
              {
                "code": "C3",
                "note": "동종업종 평균 -0.86% / KOSPI +4.02% underperform",
                "evalStatus": "not_met"
              }
            ],
            ...
            "dailyChangePct": 5.69,
            "dailyDirection": "up",
            "entryPriceText": "1,541,000원 (당일 종가 기준)",
            "entryPrice": 1541000,
            "entryMeta": "당일 종가 기준",
        ...
        "momentum": [
          {
            ...
            "orderbook": {
              ...
              "bidTotal": 15273,
              "askTotal": 6340,
              "note": "토스 호가잔량합계 매수 15,273 / 매도 6,340",
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "당일 거래량 / 20일 평균 1142% (필요 ≥ 150%)",
                "evalStatus": "met"
              },
              {
                "code": "C1",
            ...
            "dailyChange": 29350,
            "dailyChangePct": 25.79,
            "dailyDirection": "up",
            "entryPriceText": "143,150원 (당일 종가 기준)",
            "entryPrice": 143150,
            "entryMeta": "당일 종가 기준",
            ...
            "orderbook": {
              ...
              "bidTotal": 8235,
              "askTotal": 7320,
              "note": "토스 호가잔량합계 매수 8,235 / 매도 7,320",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "matchedRules": [
              {
                "code": "S1",
                "note": "외인 28,335주 / 기관 31,553주 · 동시 순매수",
                "evalStatus": "met"
              },
              {
                "code": "P1",
            ...
            "unmatchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 126.0% / 100% 유지 50.0% (필요 ≥110%·≥70%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "매수/매도 호가잔량 0.89 (필요 ≥ 1.2)",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 402000,
            ...
            "dailyChangePct": 23.5,
            "dailyDirection": "up",
            "entryPriceText": "402,000원 (당일 종가 기준)",
            "entryPrice": 402000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "상대강도 상위 여부와 돌파 지속성을 공개 데이터로 계산했습니다. 외인 28,335주 / 기관 31,553주.",
            "notes": [],
            "toss": {
              "avgStrength": 126.0,
              "note": "토스 공개 체결강도 126.0% / 최근 체결 2분 프록시",
              "source": "toss_http_combo",
              "sourceUrl": "https://www.tossinvest.com/stocks/A108490/order",
              "asOf": "2026-06-01T05:53:08Z",
              "intradayAbove100Ratio": 50.0,
              "observedMinutes": 2,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 2분 프록시",
              "lastHourAvgStrength": 64.9,
              "lastHourObservedMinutes": 2
            },
            "orderbook": {
              "bidAskRatio": 0.8923,
              "bidTotal": 1425,
              "askTotal": 1597,
              "note": "토스 호가잔량합계 매수 1,425 / 매도 1,597",
              "source": "toss_quotes_api",
        ...
        "reversal": [
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "⛔",
                "note": "1개월 수익률 +26.9% (필요 ≥ +30%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "20일 고점 대비 -8.4% (필요 -7%~-20%)",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 124.0% / 마지막 1시간 208.6% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 278,500 / 20MA 209,620",
                "evalStatus": "met"
              },
              {
                "code": "P2",
            ...
            "unmatchedRules": [
              {
                "code": "C3",
                "note": "직전 30분봉 종가 280000, 전봉 종가 279500 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 278500,
            ...
            "entryPrice": 278500,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -8.4% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "기업 이벤트 필터는 미반영"
            ],
            "manualInput": {
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 280000, 전봉 종가 279500",
              "latestOpen": 280000.0,
              "latestClose": 280000.0,
              "previousClose": 279500.0
            },
            "toss": {
              "avgStrength": 124.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 44982,
              "askTotal": 20493,
              "note": "토스 호가잔량합계 매수 44,982 / 매도 20,493",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +36.6% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "⛔",
                "note": "20일 고점 대비 -3.2% (필요 -7%~-20%)",
                "evalStatus": "not_met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 758,000 / 60MA 555,258",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "unmatchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 104.0% / 마지막 1시간 45.6% (필요 ≥90%·≥100%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "직전 30분봉 종가 751000, 전봉 종가 752000 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 758000,
            ...
            "entryPrice": 758000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -3.2% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [],
            "manualInput": {
              "required": false,
              "fields": [],
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 751000, 전봉 종가 752000",
              "latestOpen": 751000.0,
              "latestClose": 751000.0,
              "previousClose": 752000.0
            },
            "toss": {
              "avgStrength": 104.0,
              "note": "토스 공개 체결강도 104.0% / 최근 체결 2분 프록시",
          ...
          },
          {
            ...
            "gates": [
              {
                "code": "G1",
                "status": "✅",
                "note": "1개월 수익률 +108.7% (필요 ≥ +30%)",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "20일 고점 대비 -7.3% (필요 -7%~-20%)",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "종가 360,000 / 60MA 175,482",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "matchedRules": [
              {
                "code": "S2",
                "note": "당일 평균 96.0% / 마지막 1시간 116.3% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
                "note": "종가 360,000 / 20MA 201,310",
                "evalStatus": "met"
              },
              {
                "code": "P2",
            ...
            "unmatchedRules": [
              {
                "code": "S1",
                "note": "외인 -86,240→-401,522 / 기관 26,971→69,179 · 순매수 전환 없음",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "직전 30분봉 종가 350500, 전봉 종가 351500 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 360000,
            ...
            "entryPrice": 360000,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -7.3% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "기업 이벤트 필터는 미반영"
            ],
            "manualInput": {
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 350500, 전봉 종가 351500",
              "latestOpen": 350500.0,
              "latestClose": 350500.0,
              "previousClose": 351500.0
            },
            "toss": {
              "avgStrength": 96.0,
              ...
              "asOf": "2026-06-01T05:53:06Z",
              "intradayAbove100Ratio": 50.0,
              "observedMinutes": 2,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 2분 프록시",
              "lastHourAvgStrength": 116.3,
              "lastHourObservedMinutes": 2
            },
            "orderbook": {
              "bidAskRatio": 1.7535,
              "bidTotal": 2760,
              "askTotal": 1574,
              "note": "토스 호가잔량합계 매수 2,760 / 매도 1,574",
              "source": "toss_quotes_api",
