        ...
        "pullback": [
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "⛔",
                "note": "5MA 222,260 > 20MA 209,370 > 60MA 211,532 · 정배열 또는 5MA 5일 상승 미충족",
                "evalStatus": "not_met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 273,500 / 60MA 211,532",
                "evalStatus": "met"
              },
              {
                "code": "G3",
              ...
              },
              {
                "code": "G5",
                "status": "⚠️",
                "note": "KOSPI>8354.63, VKOSPI 74.41 · 거시·레짐 완화",
                "evalStatus": "not_met"
              }
            ],
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "20일 고점 대비 -10.0% (필요 -7%~-15%)",
                "evalStatus": "met"
              },
              {
                "code": "P2",
                "note": "종가 273,500 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 247,500 ≤ 종가 273,500)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 1294% (필요 100~180%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 -3.25% / KOSPI +4.24% underperform",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 273500,
            ...
            "dailyChange": 39500,
            "dailyChangePct": 16.88,
            "dailyDirection": "up",
            "entryPriceText": "273,500원 (당일 종가 기준)",
            "entryPrice": 273500,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 1,840,400 > 20MA 1,211,950 > 60MA 759,175",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 2,024,000 / 60MA 759,175",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "P2",
                "note": "종가 2,024,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C2",
            ...
            "unmatchedRules": [
              {
                "code": "C1",
                "note": "음봉 · 아래꼬리:몸통 0.32 (필요 ≥ 1.0)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 +0.95% / KOSPI +4.24% underperform",
                "evalStatus": "not_met"
              }
            ],
            ...
            "dailyChangePct": -4.84,
            "dailyDirection": "down",
            "entryPriceText": "2,024,000원 (당일 종가 기준)",
            "entryPrice": 2024000,
            "entryMeta": "당일 종가 기준",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G1",
                "status": "✅",
                "note": "5MA 1,245,800 > 20MA 846,700 > 60MA 515,275",
                "evalStatus": "met"
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "종가 1,525,000 / 60MA 515,275",
                "evalStatus": "met"
              },
              {
                "code": "G3",
            ...
            "matchedRules": [
              ...
              {
                "code": "P1",
                "note": "20일 고점 대비 -14.7% (필요 -7%~-15%)",
                "evalStatus": "met"
              },
              {
                "code": "P2",
                "note": "종가 1,525,000 · 5MA·10MA·20MA 중 5MA, 10MA, 20MA 위",
                "evalStatus": "met"
              },
              {
                "code": "C1",
                "note": "양봉 (시가 1,480,000 ≤ 종가 1,525,000)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "C2",
                "note": "당일 거래량 / 5일 평균 391% (필요 100~180%)",
                "evalStatus": "not_met"
              },
              {
                "code": "C3",
                "note": "동종업종 평균 -0.62% / KOSPI +4.24% underperform",
                "evalStatus": "not_met"
              }
            ],
        ...
        "momentum": [
          {
            ...
            "toss": {
              ...
              "asOf": "2026-06-01T06:07:55Z",
              "intradayAbove100Ratio": 100.0,
              "observedMinutes": 1,
              "observedTickCount": 120,
              "coverageNote": "최근 체결 1분 프록시",
              "lastHourAvgStrength": 242.8,
            ...
            "orderbook": {
              ...
              "bidTotal": 199561,
              "askTotal": 400413,
              "note": "토스 호가잔량합계 매수 199,561 / 매도 400,413",
          ...
          },
          {
            ...
            "gates": [
              ...
              },
              {
                "code": "G2",
                "status": "✅",
                "note": "5일 초과 +2.5% / 20일 초과 +3.6%",
                "evalStatus": "met"
              },
              {
                "code": "G3",
                "status": "✅",
                "note": "52주 고가 대비 96.3% (필요 ≥ 92%)",
                "evalStatus": "met"
              },
              {
                "code": "G4",
            ...
            "dailyChangePct": 4.29,
            "dailyDirection": "up",
            "entryPriceText": "754,000원 (당일 종가 기준)",
            "entryPrice": 754000,
            "entryMeta": "당일 종가 기준",
            ...
            "orderbook": {
              ...
              "bidTotal": 19794,
              "askTotal": 7200,
              "note": "토스 호가잔량합계 매수 19,794 / 매도 7,200",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "dailyChange": 27900,
            "dailyChangePct": 24.52,
            "dailyDirection": "up",
            "entryPriceText": "141,700원 (당일 종가 기준)",
            "entryPrice": 141700,
            "entryMeta": "당일 종가 기준",
            ...
            "orderbook": {
              ...
              "bidTotal": 6571,
              "askTotal": 9907,
              "note": "토스 호가잔량합계 매수 6,571 / 매도 9,907",
              "source": "toss_quotes_api",
        ...
        "reversal": [
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 142.0% / 마지막 1시간 242.8% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
              ...
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 224% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "직전 30분봉 종가 348250, 전봉 종가 344000 충족",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 348250, 전봉 종가 344000",
              "latestOpen": 344000.0,
              "latestClose": 348250.0,
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 1294% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C2",
                "note": "매수/매도 호가잔량 3.66 (필요 ≥ 1.0)",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
              {
                "code": "C3",
                "note": "직전 30분봉 종가 279500, 전봉 종가 280000 미달",
                "evalStatus": "not_met"
              }
            ],
            "currentPrice": 273500,
            ...
            "entryPrice": 273500,
            "entryMeta": "당일 종가 기준",
            "keyPoint": "20일 고점 대비 -10.0% 조정 후 안정화 패턴 여부를 점검했습니다.",
            "notes": [
              "기업 이벤트 필터는 미반영"
            ],
            "manualInput": {
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 279500, 전봉 종가 280000",
              "latestOpen": 279500.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 91983,
              "askTotal": 25120,
              "note": "토스 호가잔량합계 매수 91,983 / 매도 25,120",
              "source": "toss_quotes_api",
          ...
          },
          {
            ...
            "matchedRules": [
              ...
              {
                "code": "S2",
                "note": "당일 평균 125.0% / 마지막 1시간 144.6% (필요 ≥90%·≥100%)",
                "evalStatus": "met"
              },
              {
                "code": "P1",
              ...
              {
                "code": "C1",
                "note": "당일 거래량 / 5일 평균 1347% (필요 ≥ 200%)",
                "evalStatus": "met"
              },
              {
                "code": "C3",
                "note": "직전 30분봉 종가 402500, 전봉 종가 392500 충족",
                "evalStatus": "met"
              }
            ],
            "unmatchedRules": [
            ...
            "intraday30m": {
              ...
              "interval": "30m",
              "source": "yahoo_chart",
              "note": "직전 30분봉 종가 402500, 전봉 종가 392500",
              "latestOpen": 393500.0,
              "latestClose": 402500.0,
            ...
            "orderbook": {
              ...
              "bidTotal": 2432,
              "askTotal": 2633,
              "note": "토스 호가잔량합계 매수 2,432 / 매도 2,633",
              "source": "toss_quotes_api",
