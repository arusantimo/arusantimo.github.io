          ...
          <details class="ver-group">
            ...
            <ul>
              <li class="cl-tip" data-tt-title="/usage 토큰 사용량 모니터링 도입 (v0.140.0)"
                ...
                data-tt-example="">일간/주간/누적 토큰 소비 분석 <code>/usage</code> 뷰어 추가 (v0.140.0)</li>
              <li class="cl-tip" data-tt-title="/delete 및 codex delete 세션 삭제 지원 (v0.140.0)"
                ...
                data-tt-example="">안전 필터 기반 세션 영구 제거 <code>/delete</code> 및 <code>codex delete</code> 추가 (v0.140.0)</li>
              <li class="cl-tip" data-tt-title="통합 멘션 @ 메뉴 기본 노출 (v0.140.0)"
                ...
                data-tt-example="">파일/플러그인/스킬 통합 멘션 <code>@</code> 메뉴 기본 노출 지원 (v0.140.0)</li>
              <li class="cl-tip" data-tt-title="/import Claude Code 이력 마이그레이션 (v0.140.0)"
                ...
                data-tt-example="">Claude Code 설정 및 스레드 마이그레이션 <code>/import</code> 지원 (v0.140.0)</li>
              <li class="cl-tip" data-tt-title="Amazon Bedrock API key 인증 및 OAuth 자격증명 암호화 (v0.140.0)"
                ...
                data-tt-example="">Bedrock API key 인증 및 로컬 OAuth 크리덴셜 대칭 암호화 저장 패치 (v0.140.0)</li>
              <li class="cl-tip" data-tt-title="대형 레포 반응성 최적화 및 SQLite 복구 로직 (v0.140.0)"
                ...
                data-tt-example="">대용량 저장소 IO 반응 속도 개선 및 SQLite 데이터베이스 파손 자동 복구 (v0.140.0)</li>
            </ul>
          </details>
          ...
          <details class="ver-group">
            ...
            <ul>
              <li class="cl-tip" data-tt-title="/app 명령어 데스크톱 앱 전환 (v0.138.0)"
                ...
                data-tt-example="/app"><code>/app</code> 명령어로 CLI 스레드를 데스크톱 앱으로 전환 지원 (v0.138.0)</li>
              <li class="cl-tip" data-tt-title="Alt 키 대체 단축키 매핑 (v0.138.0)"
                ...
                data-tt-example="">터미널 환경용 대체 단축키(fallback shortcuts) 매핑 지원 (v0.138.0)</li>
              <li class="cl-tip" data-tt-title="이미지 경로 명시 및 편집 정합성 개선 (v0.138.0)"
                ...
                data-tt-example="">로컬 이미지 파일 경로 명시 및 후속 편집 정합성 개선 (v0.138.0)</li>
            </ul>
          </details>
      ...
      <div class="section">
        ...
        <div class="group">
          ...
          <div class="row cl-tip">
            ...
            <div class="row-desc">CLI 세션을 데스크탑 앱으로 전환</div>
          </div>
          <div class="row cl-tip">
      ...
      <div class="section">
        ...
        <div class="group">
          ...
          <div class="krow cl-tip" data-tt-title="대체 단축키 매핑 (v0.138.0)" data-tt-desc="Alt 키 바인딩이 부족하거나 미지원되는 터미널 환경을 위해 설정한 대체 단축키(fallback shortcuts) 매핑을 지원합니다.">
            ...
            <div class="kdesc">대체 단축키 매핑 지원</div>
          </div>
        </div>
        <div class="group">
