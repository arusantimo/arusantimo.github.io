...
description: "Codex와 Codex CLI 치트시트를 최신 버전으로 자동 업데이트합니다"
---
...
- `tools/Codex-content.js` — Codex 콘텐츠 영역
...
**Codex:**
- https://github.com/anthropics/Codex/releases (최신 stable 태그 확인)
- https://code.Codex.com/docs/en/changelog (릴리스 날짜·기능 목록)
- **로컬 확인**: `Codex` 실행 후 `/help`를 입력하여 문서에 반영되지 않은 최신 명령어 목록 확인
...
- Codex: `tools/Codex-content.js` 내 `<span class="meta-version">`
...
1. 탭 버튼 영역 내 `<span class="tab-ver">vX.X.XXX</span>` 버전 업데이트 (Codex 및 Codex)
